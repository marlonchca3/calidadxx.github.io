...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:fi,depthTest:!1,depthWrite:!1})}function fd(){return new Kn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:eo(),fragmentShader:`
		...
		`,blending:fi,depthTest:!1,depthWrite:!1})}function hd(){return new Kn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:eo(),fragmentShader:`
...
`)}const qS={[eh]:"Linear",[th]:"Reinhard",[nh]:"Cineon",[ih]:"ACESFilmic",[rh]:"AgX",[ah]:"Neutral",[sh]:"Custom"};function KS(n,e){const t=qS[e];return t===void 0?(Ke("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+n+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const da=new B;function ZS(){st.getLuminanceCoefficients(da);const n=da.x.toFixed(4),e=da.y.toFixed(4),t=da.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`].filter(nr).join(`
`)),a=ic(a),a=yd(a,t),a=Ed(a,t),o=ic(o),o=yd(o,t),o=Ed(o,t),a=Td(a),o=Td(o),t.isRawShaderMaterial!==!0&&(y=`#version 300 es
...
`)+`
`+p);const P=y+m+a,S=y+p+o,T=Sd(s,s.VERTEX_SHADER,P),A=Sd(s,s.FRAGMENT_SHADER,S);s.attachShader(b,T),s.attachShader(b,A),t.index0AttributeName!==void 0?s.bindAttribLocation(b,0,t.index0AttributeName):t.hasPositionAttribute===!0&&s.bindAttribLocation(b,0,"position"),s.linkProgram(b);function D(N){if(n.debug.checkShaderErrors){const k=s.getProgramInfoLog(b)||"",q=s.getShaderInfoLog(T)||"",H=s.getShaderInfoLog(A)||"",W=k.trim(),te=q.trim(),z=H.trim();let ie=!0,Z=!0;if(s.getProgramParameter(b,s.LINK_STATUS)===!1)if(ie=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(s,b,T,A);else{const J=bd(s,T,"vertex"),le=bd(s,A,"fragment");lt("WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(b,s.VALIDATE_STATUS)+`
...
Program Info Log: `+W+`
`+J+`
`+le)}else W!==""?Ke("WebGLProgram: Program Info Log:",W):(te===""||z==="")&&(Z=!1);Z&&(N.diagnostics={runnable:ie,programLog:W,vertexShader:{log:te,prefix:m},fragmentShader:{log:z,prefix:p}})}s.deleteShader(T),s.deleteShader(A),x=new Sa(s,b),w=QS(s,b)}let x;this.getUniforms=function(){return x===void 0&&D(this),x};let w;this.getAttributes=function(){return w===void 0&&D(this),w};let L=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return L===!1&&(L=s.getProgramParameter(b,zS)),L},this.destroy=function(){i.releaseStatesOfProgram(this),s.deleteProgram(b),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=GS++,this.cacheKey=e,this.usedTimes=1,this.program=b,this.vertexShader=T,this.fragmentShader=A,this}let pM=0;class mM{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e,t,i){const s=this._getShaderCacheForMaterial(e);return s.has(t)===!1&&(s.add(t),t.usedTimes++),s.has(i)===!1&&(s.add(i),i.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const i of t)i.usedTimes--,i.usedTimes===0&&this.shaderCache.delete(i.code);return this.materialCache.delete(e),this}getVertexShaderStage(e){return this._getShaderStage(e.vertexShader)}getFragmentShaderStage(e){return this._getShaderStage(e.fragmentShader)}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let i=t.get(e);return i===void 0&&(i=new Set,t.set(e,i)),i}_getShaderStage(e){const t=this.shaderCache;let i=t.get(e);return i===void 0&&(i=new gM(e),t.set(e,i)),i}}class gM{constructor(e){this.id=pM++,this.code=e,this.usedTimes=0}}function _M(n){return n===ts||n===Ca||n===Pa}function vM(n,e,t,i,s,r){const a=new _h,o=new mM,l=new Set,c=[],u=new Map,f=i.logarithmicDepthBuffer;let d=i.precision;const h={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function v(x){return l.add(x),x===0?"uv":`uv${x}`}function b(x,w,L,N,k,q){const H=N.fog,W=k.geometry,te=x.isMeshStandardMaterial||x.isMeshLambertMaterial||x.isMeshPhongMaterial?N.environment:null,z=x.isMeshStandardMaterial||x.isMeshLambertMaterial&&!x.envMap||x.isMeshPhongMaterial&&!x.envMap,ie=e.get(x.envMap||te,z),Z=ie&&ie.mapping===Qa?ie.image.height:null,J=h[x.type];x.precision!==null&&(d=i.getMaxPrecision(x.precision),d!==x.precision&&Ke("WebGLProgram.getParameters:",x.precision,"not supported, using",d,"instead."));const le=W.morphAttributes.position||W.morphAttributes.normal||W.morphAttributes.color,ee=le!==void 0?le.length:0;let ve=0;W.morphAttributes.position!==void 0&&(ve=1),W.morphAttributes.normal!==void 0&&(ve=2),W.morphAttributes.color!==void 0&&(ve=3);let $e,Ge,We,Q;if(J){const bt=Hn[J];$e=bt.vertexShader,Ge=bt.fragmentShader}else{$e=x.vertexShader,Ge=x.fragmentShader;const bt=o.getVertexShaderStage(x),ut=o.getFragmentShaderStage(x);o.update(x,bt,ut),We=bt.id,Q=ut.id}const ae=n.getRenderTarget(),Te=n.state.buffers.depth.getReversed(),ze=k.isInstancedMesh===!0,De=k.isBatchedMesh===!0,R=!!x.map,I=!!x.matcap,G=!!ie,se=!!x.aoMap,re=!!x.lightMap,j=!!x.bumpMap&&x.wireframe===!1,fe=!!x.normalMap,he=!!x.displacementMap,pe=!!x.emissiveMap,oe=!!x.metalnessMap,Ce=!!x.roughnessMap,C=x.anisotropy>0,Le=x.clearcoat>0,Ee=x.dispersion>0,E=x.retroreflectivity>0,g=x.iridescence>0,U=x.sheen>0,V=x.transmission>0,K=C&&!!x.anisotropyMap,me=Le&&!!x.clearcoatMap,_e=Le&&!!x.clearcoatNormalMap,ne=Le&&!!x.clearcoatRoughnessMap,ce=g&&!!x.iridescenceMap,ge=g&&!!x.iridescenceThicknessMap,Ie=U&&!!x.sheenColorMap,Me=U&&!!x.sheenRoughnessMap,Se=!!x.specularMap,ke=!!x.specularColorMap,Ye=!!x.specularIntensityMap,Qe=V&&!!x.transmissionMap,O=V&&!!x.thicknessMap,be=!!x.gradientMap,ue=!!x.alphaMap,ye=x.alphaTest>0,Pe=!!x.alphaHash,de=!!x.extensions;let Ve=Wn;x.toneMapped&&(ae===null||ae.isXRRenderTarget===!0)&&(Ve=n.toneMapping);const Be={shaderID:J,shaderType:x.type,shaderName:x.name,vertexShader:$e,fragmentShader:Ge,defines:x.defines,customVertexShaderID:We,customFragmentShaderID:Q,isRawShaderMaterial:x.isRawShaderMaterial===!0,glslVersion:x.glslVersion,precision:d,batching:De,batchingColor:De&&k._colorsTexture!==null,instancing:ze,instancingColor:ze&&k.instanceColor!==null,instancingMorph:ze&&k.morphTexture!==null,outputColorSpace:ae===null?n.outputColorSpace:ae.isXRRenderTarget===!0?ae.texture.colorSpace:st.workingColorSpace,alphaToCoverage:!!x.alphaToCoverage,map:R,matcap:I,envMap:G,envMapMode:G&&ie.mapping,envMapCubeUVHeight:Z,aoMap:se,lightMap:re,bumpMap:j,normalMap:fe,displacementMap:he,emissiveMap:pe,normalMapObjectSpace:fe&&x.normalMapType===$g,normalMapTangentSpace:fe&&x.normalMapType===Lu,packedNormalMap:fe&&x.normalMapType===Lu&&_M(x.normalMap.format),metalnessMap:oe,roughnessMap:Ce,anisotropy:C,anisotropyMap:K,clearcoat:Le,clearcoatMap:me,clearcoatNormalMap:_e,clearcoatRoughnessMap:ne,dispersion:Ee,retroreflection:E,iridescence:g,iridescenceMap:ce,iridescenceThicknessMap:ge,sheen:U,sheenColorMap:Ie,sheenRoughnessMap:Me,specularMap:Se,specularColorMap:ke,specularIntensityMap:Ye,transmission:V,transmissionMap:Qe,thicknessMap:O,gradientMap:be,opaque:x.transparent===!1&&x.blending===dr&&x.alphaToCoverage===!1,alphaMap:ue,alphaTest:ye,alphaHash:Pe,combine:x.combine,mapUv:R&&v(x.map.channel),aoMapUv:se&&v(x.aoMap.channel),lightMapUv:re&&v(x.lightMap.channel),bumpMapUv:j&&v(x.bumpMap.channel),normalMapUv:fe&&v(x.normalMap.channel),displacementMapUv:he&&v(x.displacementMap.channel),emissiveMapUv:pe&&v(x.emissiveMap.channel),metalnessMapUv:oe&&v(x.metalnessMap.channel),roughnessMapUv:Ce&&v(x.roughnessMap.channel),anisotropyMapUv:K&&v(x.anisotropyMap.channel),clearcoatMapUv:me&&v(x.clearcoatMap.channel),clearcoatNormalMapUv:_e&&v(x.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:ne&&v(x.clearcoatRoughnessMap.channel),iridescenceMapUv:ce&&v(x.iridescenceMap.channel),iridescenceThicknessMapUv:ge&&v(x.iridescenceThicknessMap.channel),sheenColorMapUv:Ie&&v(x.sheenColorMap.channel),sheenRoughnessMapUv:Me&&v(x.sheenRoughnessMap.channel),specularMapUv:Se&&v(x.specularMap.channel),specularColorMapUv:ke&&v(x.specularColorMap.channel),specularIntensityMapUv:Ye&&v(x.specularIntensityMap.channel),transmissionMapUv:Qe&&v(x.transmissionMap.channel),thicknessMapUv:O&&v(x.thicknessMap.channel),alphaMapUv:ue&&v(x.alphaMap.channel),vertexTangents:!!W.attributes.tangent&&(fe||C),vertexNormals:!!W.attributes.normal,vertexColors:x.vertexColors,vertexAlphas:x.vertexColors===!0&&!!W.attributes.color&&W.attributes.color.itemSize===4,pointsUvs:k.isPoints===!0&&!!W.attributes.uv&&(R||ue),fog:!!H,useFog:x.fog===!0,fogExp2:!!H&&H.isFogExp2,flatShading:x.wireframe===!1&&(x.flatShading===!0||W.attributes.normal===void 0&&fe===!1&&(x.isMeshLambertMaterial||x.isMeshPhongMaterial||x.isMeshStandardMaterial||x.isMeshPhysicalMaterial)),sizeAttenuation:x.sizeAttenuation===!0,logarithmicDepthBuffer:f,reversedDepthBuffer:Te,skinning:k.isSkinnedMesh===!0,hasPositionAttribute:W.attributes.position!==void 0,morphTargets:W.morphAttributes.position!==void 0,morphNormals:W.morphAttributes.normal!==void 0,morphColors:W.morphAttributes.color!==void 0,morphTargetsCount:ee,morphTextureStride:ve,numSunLights:w.sun.length,numDirLights:w.directional.length,numPointLights:w.point.length,numSpotLights:w.spot.length,numSpotLightMaps:w.spotLightMap.length,numRectAreaLights:w.rectArea.length,numHemiLights:w.hemi.length,numSunLightShadows:w.sunShadowMap.length,numDirLightShadows:w.directionalShadowMap.length,numPointLightShadows:w.pointShadowMap.length,numSpotLightShadows:w.spotShadowMap.length,numSpotLightShadowsWithMaps:w.numSpotLightShadowsWithMaps,numLightProbes:w.numLightProbes,numLightProbeGrids:q.length,numClippingPlanes:r.numPlanes,numClipIntersection:r.numIntersection,dithering:x.dithering,shadowMapEnabled:n.shadowMap.enabled&&L.length>0,shadowMapType:n.shadowMap.type,toneMapping:Ve,decodeVideoTexture:R&&x.map.isVideoTexture===!0&&st.getTransfer(x.map.colorSpace)===ht,decodeVideoTextureEmissive:pe&&x.emissiveMap.isVideoTexture===!0&&st.getTransfer(x.emissiveMap.colorSpace)===ht,premultipliedAlpha:x.premultipliedAlpha,doubleSided:x.side===ci,flipSided:x.side===an,useDepthPacking:x.depthPacking>=0,depthPacking:x.depthPacking||0,index0AttributeName:x.index0AttributeName,extensionClipCullDistance:de&&x.extensions.clipCullDistance===!0&&t.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(de&&x.extensions.multiDraw===!0||De)&&t.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:t.has("KHR_parallel_shader_compile"),customProgramCacheKey:x.customProgramCacheKey()};return Be.vertexUv1s=l.has(1),Be.vertexUv2s=l.has(2),Be.vertexUv3s=l.has(3),l.clear(),Be}function m(x){const w=[];if(x.shaderID?w.push(x.shaderID):(w.push(x.customVertexShaderID),w.push(x.customFragmentShaderID)),x.defines!==void 0)for(const L in x.defines)w.push(L),w.push(x.defines[L]);return x.isRawShaderMaterial===!1&&(p(w,x),y(w,x),w.push(n.outputColorSpace)),w.push(x.customProgramCacheKey),w.join()}function p(x,w){x.push(w.precision),x.push(w.outputColorSpace),x.push(w.envMapMode),x.push(w.envMapCubeUVHeight),x.push(w.mapUv),x.push(w.alphaMapUv),x.push(w.lightMapUv),x.push(w.aoMapUv),x.push(w.bumpMapUv),x.push(w.normalMapUv),x.push(w.displacementMapUv),x.push(w.emissiveMapUv),x.push(w.metalnessMapUv),x.push(w.roughnessMapUv),x.push(w.anisotropyMapUv),x.push(w.clearcoatMapUv),x.push(w.clearcoatNormalMapUv),x.push(w.clearcoatRoughnessMapUv),x.push(w.iridescenceMapUv),x.push(w.iridescenceThicknessMapUv),x.push(w.sheenColorMapUv),x.push(w.sheenRoughnessMapUv),x.push(w.specularMapUv),x.push(w.specularColorMapUv),x.push(w.specularIntensityMapUv),x.push(w.transmissionMapUv),x.push(w.thicknessMapUv),x.push(w.combine),x.push(w.fogExp2),x.push(w.sizeAttenuation),x.push(w.morphTargetsCount),x.push(w.morphAttributeCount),x.push(w.numSunLights),x.push(w.numDirLights),x.push(w.numPointLights),x.push(w.numSpotLights),x.push(w.numSpotLightMaps),x.push(w.numHemiLights),x.push(w.numRectAreaLights),x.push(w.numSunLightShadows),x.push(w.numDirLightShadows),x.push(w.numPointLightShadows),x.push(w.numSpotLightShadows),x.push(w.numSpotLightShadowsWithMaps),x.push(w.numLightProbes),x.push(w.shadowMapType),x.push(w.toneMapping),x.push(w.numClippingPlanes),x.push(w.numClipIntersection),x.push(w.depthPacking)}function y(x,w){a.disableAll(),w.instancing&&a.enable(0),w.instancingColor&&a.enable(1),w.instancingMorph&&a.enable(2),w.matcap&&a.enable(3),w.envMap&&a.enable(4),w.normalMapObjectSpace&&a.enable(5),w.normalMapTangentSpace&&a.enable(6),w.clearcoat&&a.enable(7),w.iridescence&&a.enable(8),w.alphaTest&&a.enable(9),w.vertexColors&&a.enable(10),w.vertexAlphas&&a.enable(11),w.vertexUv1s&&a.enable(12),w.vertexUv2s&&a.enable(13),w.vertexUv3s&&a.enable(14),w.vertexTangents&&a.enable(15),w.anisotropy&&a.enable(16),w.alphaHash&&a.enable(17),w.batching&&a.enable(18),w.dispersion&&a.enable(19),w.retroreflection&&a.enable(24),w.batchingColor&&a.enable(20),w.gradientMap&&a.enable(21),w.packedNormalMap&&a.enable(22),w.vertexNormals&&a.enable(23),x.push(a.mask),a.disableAll(),w.fog&&a.enable(0),w.useFog&&a.enable(1),w.flatShading&&a.enable(2),w.logarithmicDepthBuffer&&a.enable(3),w.reversedDepthBuffer&&a.enable(4),w.skinning&&a.enable(5),w.morphTargets&&a.enable(6),w.morphNormals&&a.enable(7),w.morphColors&&a.enable(8),w.premultipliedAlpha&&a.enable(9),w.shadowMapEnabled&&a.enable(10),w.doubleSided&&a.enable(11),w.flipSided&&a.enable(12),w.useDepthPacking&&a.enable(13),w.dithering&&a.enable(14),w.transmission&&a.enable(15),w.sheen&&a.enable(16),w.opaque&&a.enable(17),w.pointsUvs&&a.enable(18),w.decodeVideoTexture&&a.enable(19),w.decodeVideoTextureEmissive&&a.enable(20),w.alphaToCoverage&&a.enable(21),w.numLightProbeGrids>0&&a.enable(22),w.hasPositionAttribute&&a.enable(23),x.push(a.mask)}function P(x){const w=h[x.type];let L;if(w){const N=Hn[w];L=H0.clone(N.uniforms)}else L=x.uniforms;return L}function S(x,w){let L=u.get(w);return L!==void 0?++L.usedTimes:(L=new hM(n,w,x,s),c.push(L),u.set(w,L)),L}function T(x){if(--x.usedTimes===0){const w=c.indexOf(x);c[w]=c[c.length-1],c.pop(),u.delete(x.cacheKey),x.destroy()}}function A(x){o.remove(x)}function D(){o.dispose()}return{getParameters:b,getProgramCacheKey:m,getUniforms:P,acquireProgram:S,releaseProgram:T,releaseShaderCache:A,programs:c,dispose:D}}function xM(){let n=new WeakMap;function e(a){return n.has(a)}function t(a){let o=n.get(a);return o===void 0&&(o={},n.set(a,o)),o}function i(a){n.delete(a)}function s(a,o,l){n.get(a)[o]=l}function r(){n=new WeakMap}return{has:e,get:t,remove:i,update:s,dispose:r}}function SM(n,e){return n.groupOrder!==e.groupOrder?n.groupOrder-e.groupOrder:n.renderOrder!==e.renderOrder?n.renderOrder-e.renderOrder:n.material.id!==e.material.id?n.material.id-e.material.id:n.materialVariant!==e.materialVariant?n.materialVariant-e.materialVariant:n.z!==e.z?n.z-e.z:n.id-e.id}function wd(n,e){return n.groupOrder!==e.groupOrder?n.groupOrder-e.groupOrder:n.renderOrder!==e.renderOrder?n.renderOrder-e.renderOrder:n.z!==e.z?e.z-n.z:n.id-e.id}function Rd(){const n=[];let e=0;const t=[],i=[],s=[];function r(){e=0,t.length=0,i.length=0,s.length=0}function a(d){let h=0;return d.isInstancedMesh&&(h+=2),d.isSkinnedMesh&&(h+=1),h}function o(d,h,v,b,m,p){let y=n[e];return y===void 0?(y={id:d.id,object:d,geometry:h,material:v,materialVariant:a(d),groupOrder:b,renderOrder:d.renderOrder,z:m,group:p},n[e]=y):(y.id=d.id,y.object=d,y.geometry=h,y.material=v,y.materialVariant=a(d),y.groupOrder=b,y.renderOrder=d.renderOrder,y.z=m,y.group=p),e++,y}function l(d,h,v,b,m,p,y){y.reversedDepth===!0&&(m=-m);const P=o(d,h,v,b,m,p);v.transmission>0?i.push(P):v.transparent===!0?s.push(P):t.push(P)}function c(d,h,v,b,m,p){const y=o(d,h,v,b,m,p);v.transmission>0?i.unshift(y):v.transparent===!0?s.unshift(y):t.unshift(y)}function u(d,h){t.length>1&&t.sort(d||SM),i.length>1&&i.sort(h||wd),s.length>1&&s.sort(h||wd)}function f(){for(let d=e,h=n.length;d<h;d++){const v=n[d];if(v.id===null)break;v.id=null,v.object=null,v.geometry=null,v.material=null,v.group=null}}return{opaque:t,transmissive:i,transparent:s,init:r,push:l,unshift:c,finish:f,sort:u}}function MM(){let n=new WeakMap;function e(i,s){const r=n.get(i);let a;return r===void 0?(a=new Rd,n.set(i,[a])):s>=r.length?(a=new Rd,r.push(a)):a=r[s],a}function t(){n=new WeakMap}return{get:e,dispose:t}}function bM(){const n={};return{get:function(e){if(n[e.id]!==void 0)return n[e.id];let t;switch(e.type){case"SunLight":case"DirectionalLight":t={direction:new B,color:new ct};break;case"SpotLight":t={position:new B,direction:new B,color:new ct,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new B,color:new ct,distance:0,decay:0};break;case"HemisphereLight":t={direction:new B,skyColor:new ct,groundColor:new ct};break;case"RectAreaLight":t={color:new ct,position:new B,halfWidth:new B,halfHeight:new B};break}return n[e.id]=t,t}}}function yM(){const n={};return{get:function(e){if(n[e.id]!==void 0)return n[e.id];let t;switch(e.type){case"SunLight":case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new rt};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new rt};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new rt,shadowCameraNear:1,shadowCameraFar:1e3};break}return n[e.id]=t,t}}}let EM=0;function TM(n,e){return(e.castShadow?2:0)-(n.castShadow?2:0)+(e.map?1:0)-(n.map?1:0)}function AM(n){const e=new bM,t=yM(),i={version:0,hash:{sunLength:-1,directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numSunShadows:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],sun:[],sunShadow:[],sunShadowMap:[],sunShadowMatrix:[],sunShadowCascade:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)i.probe.push(new B);const s=new B,r=new At,a=new At;function o(c){let u=0,f=0,d=0;for(let k=0;k<9;k++)i.probe[k].set(0,0,0);let h=0,v=0,b=0,m=0,p=0,y=0,P=0,S=0,T=0,A=0,D=0,x=0,w=0,L=0;c.sort(TM);for(let k=0,q=c.length;k<q;k++){const H=c[k],W=H.color,te=H.intensity,z=H.distance;let ie=null;if(H.shadow&&H.shadow.map&&(H.shadow.map.texture.format===ts?ie=H.shadow.map.texture:ie=H.shadow.map.depthTexture||H.shadow.map.texture),H.isAmbientLight)u+=W.r*te,f+=W.g*te,d+=W.b*te;else if(H.isLightProbe){for(let Z=0;Z<9;Z++)i.probe[Z].addScaledVector(H.sh.coefficients[Z],te);L++}else if(H.isSunLight){const Z=e.get(H);if(Z.color.copy(H.color).multiplyScalar(H.intensity),H.castShadow){const J=H.shadow,le=t.get(H);le.shadowIntensity=J.intensity,le.shadowBias=J.bias,le.shadowNormalBias=J.normalBias,le.shadowRadius=J.radius,le.shadowMapSize.copy(J.mapSize).multiply(J.getFrameExtents()),i.sunShadow[v]=le,i.sunShadowMap[v]=ie;const ee=J.getViewportCount();for(let ve=0;ve<ee;ve++)i.sunShadowMatrix[b+ve]=J.getMatrix(ve),i.sunShadowCascade[b+ve]=J._cascadeData[ve];b+=ee,v++}i.sun[h]=Z,h++}else if(H.isDirectionalLight){const Z=e.get(H);if(Z.color.copy(H.color).multiplyScalar(H.intensity),H.castShadow){const J=H.shadow,le=t.get(H);le.shadowIntensity=J.intensity,le.shadowBias=J.bias,le.shadowNormalBias=J.normalBias,le.shadowRadius=J.radius,le.shadowMapSize=J.mapSize,i.directionalShadow[m]=le,i.directionalShadowMap[m]=ie,i.directionalShadowMatrix[m]=H.shadow.matrix,T++}i.directional[m]=Z,m++}else if(H.isSpotLight){const Z=e.get(H);Z.position.setFromMatrixPosition(H.matrixWorld),Z.color.copy(W).multiplyScalar(te),Z.distance=z,Z.coneCos=Math.cos(H.angle),Z.penumbraCos=Math.cos(H.angle*(1-H.penumbra)),Z.decay=H.decay,i.spot[y]=Z;const J=H.shadow;if(H.map&&(i.spotLightMap[x]=H.map,x++,J.updateMatrices(H),H.castShadow&&w++),i.spotLightMatrix[y]=J.matrix,H.castShadow){const le=t.get(H);le.shadowIntensity=J.intensity,le.shadowBias=J.bias,le.shadowNormalBias=J.normalBias,le.shadowRadius=J.radius,le.shadowMapSize=J.mapSize,i.spotShadow[y]=le,i.spotShadowMap[y]=ie,D++}y++}else if(H.isRectAreaLight){const Z=e.get(H);Z.color.copy(W).multiplyScalar(te),Z.halfWidth.set(H.width*.5,0,0),Z.halfHeight.set(0,H.height*.5,0),i.rectArea[P]=Z,P++}else if(H.isPointLight){const Z=e.get(H);if(Z.color.copy(H.color).multiplyScalar(H.intensity),Z.distance=H.distance,Z.decay=H.decay,H.castShadow){const J=H.shadow,le=t.get(H);le.shadowIntensity=J.intensity,le.shadowBias=J.bias,le.shadowNormalBias=J.normalBias,le.shadowRadius=J.radius,le.shadowMapSize=J.mapSize,le.shadowCameraNear=J.camera.near,le.shadowCameraFar=J.camera.far,i.pointShadow[p]=le,i.pointShadowMap[p]=ie,i.pointShadowMatrix[p]=H.shadow.matrix,A++}i.point[p]=Z,p++}else if(H.isHemisphereLight){const Z=e.get(H);Z.skyColor.copy(H.color).multiplyScalar(te),Z.groundColor.copy(H.groundColor).multiplyScalar(te),i.hemi[S]=Z,S++}}P>0&&(n.has("OES_texture_float_linear")===!0?(i.rectAreaLTC1=Ae.LTC_FLOAT_1,i.rectAreaLTC2=Ae.LTC_FLOAT_2):(i.rectAreaLTC1=Ae.LTC_HALF_1,i.rectAreaLTC2=Ae.LTC_HALF_2)),i.ambient[0]=u,i.ambient[1]=f,i.ambient[2]=d;const N=i.hash;(N.sunLength!==h||N.directionalLength!==m||N.pointLength!==p||N.spotLength!==y||N.rectAreaLength!==P||N.hemiLength!==S||N.numSunShadows!==v||N.numDirectionalShadows!==T||N.numPointShadows!==A||N.numSpotShadows!==D||N.numSpotMaps!==x||N.numLightProbes!==L)&&(i.sun.length=h,i.directional.length=m,i.spot.length=y,i.rectArea.length=P,i.point.length=p,i.hemi.length=S,i.sunShadow.length=v,i.sunShadowMap.length=v,i.sunShadowMatrix.length=b,i.sunShadowCascade.length=b,i.directionalShadow.length=T,i.directionalShadowMap.length=T,i.directionalShadowMatrix.length=T,i.pointShadow.length=A,i.pointShadowMap.length=A,i.pointShadowMatrix.length=A,i.spotShadow.length=D,i.spotShadowMap.length=D,i.spotLightMatrix.length=D+x-w,i.spotLightMap.length=x,i.numSpotLightShadowsWithMaps=w,i.numLightProbes=L,N.sunLength=h,N.directionalLength=m,N.pointLength=p,N.spotLength=y,N.rectAreaLength=P,N.hemiLength=S,N.numSunShadows=v,N.numDirectionalShadows=T,N.numPointShadows=A,N.numSpotShadows=D,N.numSpotMaps=x,N.numLightProbes=L,i.version=EM++)}function l(c,u){let f=0,d=0,h=0,v=0,b=0,m=0;const p=u.matrixWorldInverse;for(let y=0,P=c.length;y<P;y++){const S=c[y];if(S.isSunLight){const T=i.sun[f];T.direction.setFromMatrixPosition(S.matrixWorld),T.direction.transformDirection(p),f++}else if(S.isDirectionalLight){const T=i.directional[d];T.direction.setFromMatrixPosition(S.matrixWorld),s.setFromMatrixPosition(S.target.matrixWorld),T.direction.sub(s),T.direction.transformDirection(p),d++}else if(S.isSpotLight){const T=i.spot[v];T.position.setFromMatrixPosition(S.matrixWorld),T.position.applyMatrix4(p),T.direction.setFromMatrixPosition(S.matrixWorld),s.setFromMatrixPosition(S.target.matrixWorld),T.direction.sub(s),T.direction.transformDirection(p),v++}else if(S.isRectAreaLight){const T=i.rectArea[b];T.position.setFromMatrixPosition(S.matrixWorld),T.position.applyMatrix4(p),a.identity(),r.copy(S.matrixWorld),r.premultiply(p),a.extractRotation(r),T.halfWidth.set(S.width*.5,0,0),T.halfHeight.set(0,S.height*.5,0),T.halfWidth.applyMatrix4(a),T.halfHeight.applyMatrix4(a),b++}else if(S.isPointLight){const T=i.point[h];T.position.setFromMatrixPosition(S.matrixWorld),T.position.applyMatrix4(p),h++}else if(S.isHemisphereLight){const T=i.hemi[m];T.direction.setFromMatrixPosition(S.matrixWorld),T.direction.transformDirection(p),m++}}}return{setup:o,setupView:l,state:i}}function Cd(n){const e=new AM(n),t=[],i=[],s=[];function r(d){f.camera=d,t.length=0,i.length=0,s.length=0}function a(d){t.push(d)}function o(d){i.push(d)}function l(d){s.push(d)}function c(){e.setup(t)}function u(d){e.setupView(t,d)}const f={lightsArray:t,shadowsArray:i,lightProbeGridArray:s,camera:null,lights:e,transmissionRenderTarget:{},textureUnits:0};return{init:r,state:f,setupLights:c,setupLightsView:u,pushLight:a,pushShadow:o,pushLightProbeGrid:l}}function wM(n){let e=new WeakMap;function t(s,r=0){const a=e.get(s);let o;return a===void 0?(o=new Cd(n),e.set(s,[o])):r>=a.length?(o=new Cd(n),a.push(o)):o=a[r],o}function i(){e=new WeakMap}return{get:t,dispose:i}}const RM=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`,PM=[new B(1,0,0),new B(-1,0,0),new B(0,1,0),new B(0,-1,0),new B(0,0,1),new B(0,0,-1)],DM=[new B(0,-1,0),new B(0,-1,0),new B(0,0,1),new B(0,0,-1),new B(0,-1,0),new B(0,-1,0)],Pd=new At,$s=new B,jo=new B;function LM(n,e,t){let i=new Mh;const s=new rt,r=new rt,a=new wt,o=new G0,l=new W0,c={},u=t.maxTextureSize,f={[ji]:an,[an]:ji,[ci]:ci},d=new Kn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new rt},radius:{value:4}},vertexShader:RM,fragmentShader:CM}),h=d.clone();h.defines.HORIZONTAL_PASS=1;const v=new Ht;v.setAttribute("position",new pi(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const b=new dn(v,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=ma;let p=this.type;this.render=function(A,D,x){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||A.length===0)return;this.type===wg&&(Ke("WebGLShadowMap: PCFSoftShadowMap has been removed. Using PCFShadowMap instead."),this.type=ma);const w=n.getRenderTarget(),L=n.getActiveCubeFace(),N=n.getActiveMipmapLevel(),k=n.state;k.setBlending(fi),k.buffers.depth.getReversed()===!0?k.buffers.color.setClear(0,0,0,0):k.buffers.color.setClear(1,1,1,1),k.buffers.depth.setTest(!0),k.setScissorTest(!1);const q=p!==this.type;q&&D.traverse(function(H){H.material&&(Array.isArray(H.material)?H.material.forEach(W=>W.needsUpdate=!0):H.material.needsUpdate=!0)});for(let H=0,W=A.length;H<W;H++){const te=A[H],z=te.shadow;if(z===void 0){Ke("WebGLShadowMap:",te,"has no shadow.");continue}if(z.autoUpdate===!1&&z.needsUpdate===!1)continue;s.copy(z.mapSize);const ie=z.getFrameExtents();s.multiply(ie),r.copy(z.mapSize),(s.x>u||s.y>u)&&(s.x>u&&(r.x=Math.floor(u/ie.x),s.x=r.x*ie.x,z.mapSize.x=r.x),s.y>u&&(r.y=Math.floor(u/ie.y),s.y=r.y*ie.y,z.mapSize.y=r.y));const Z=n.state.buffers.depth.getReversed();if(z.camera._reversedDepth=Z,z.map===null||q===!0){if(z.map!==null&&(z.map.depthTexture!==null&&(z.map.depthTexture.dispose(),z.map.depthTexture=null),z.map.dispose()),this.type===tr){if(te.isPointLight){Ke("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}z.map=new Cn(s.x,s.y,{format:ts,type:qn,minFilter:Xt,magFilter:Xt,generateMipmaps:!1}),z.map.texture.name=te.name+".shadowMap",z.map.depthTexture=new yr(s.x,s.y,Vn),z.map.depthTexture.name=te.name+".shadowMapDepth",z.map.depthTexture.format=xi,z.map.depthTexture.compareFunction=null,z.map.depthTexture.minFilter=Bt,z.map.depthTexture.magFilter=Bt}else te.isPointLight?(z.map=new Ph(s.x),z.map.depthTexture=new N0(s.x,Yn)):(z.map=new Cn(s.x,s.y),z.map.depthTexture=new yr(s.x,s.y,Yn)),z.map.depthTexture.name=te.name+".shadowMap",z.map.depthTexture.format=xi,this.type===ma?(z.map.depthTexture.compareFunction=Z?Cc:Rc,z.map.depthTexture.minFilter=Xt,z.map.depthTexture.magFilter=Xt):(z.map.depthTexture.compareFunction=null,z.map.depthTexture.minFilter=Bt,z.map.depthTexture.magFilter=Bt);z.camera.updateProjectionMatrix()}z.map.isWebGLCubeRenderTarget!==!0&&(z.map.width!==s.x||z.map.height!==s.y)&&z.map.setSize(s.x,s.y);const J=z.map.isWebGLCubeRenderTarget?6:z.getViewportCount();te.isPointLight!==!0&&z.updateMatrices(te,x);for(let le=0;le<J;le++){const ee=z.getCamera(le);if(te.isPointLight){const ve=z.camera,$e=z.matrix,Ge=te.distance||ve.far;Ge!==ve.far&&(ve.far=Ge,ve.updateProjectionMatrix()),$s.setFromMatrixPosition(te.matrixWorld),ve.position.copy($s),jo.copy(ve.position),jo.add(PM[le]),ve.up.copy(DM[le]),ve.lookAt(jo),ve.updateMatrixWorld(),$e.makeTranslation(-$s.x,-$s.y,-$s.z),Pd.multiplyMatrices(ve.projectionMatrix,ve.matrixWorldInverse),z._frustum.setFromProjectionMatrix(Pd,ve.coordinateSystem,ve.reversedDepth)}if(z.map.isWebGLCubeRenderTarget)n.setRenderTarget(z.map,le),n.clear();else{le===0&&(n.setRenderTarget(z.map),n.clear());const ve=z.getViewport(le);a.set(r.x*ve.x,r.y*ve.y,r.x*ve.z,r.y*ve.w),k.viewport(a)}i=z.getFrustum(le),S(D,x,ee,te,this.type)}z.isPointLightShadow!==!0&&this.type===tr&&y(z,x),z.needsUpdate=!1}p=this.type,m.needsUpdate=!1,n.setRenderTarget(w,L,N)};function y(A,D){const x=e.update(b);d.defines.VSM_SAMPLES!==A.blurSamples&&(d.defines.VSM_SAMPLES=A.blurSamples,h.defines.VSM_SAMPLES=A.blurSamples,d.needsUpdate=!0,h.needsUpdate=!0),A.mapPass===null?A.mapPass=new Cn(s.x,s.y,{format:ts,type:qn}):(A.mapPass.width!==A.map.width||A.mapPass.height!==A.map.height)&&A.mapPass.setSize(A.map.width,A.map.height),d.uniforms.shadow_pass.value=A.map.depthTexture,d.uniforms.resolution.value.set(A.map.width,A.map.height),d.uniforms.radius.value=A.radius,n.setRenderTarget(A.mapPass),n.clear(),n.renderBufferDirect(D,null,x,d,b,null),h.uniforms.shadow_pass.value=A.mapPass.texture,h.uniforms.resolution.value.set(A.map.width,A.map.height),h.uniforms.radius.value=A.radius,n.setRenderTarget(A.map),n.clear(),n.renderBufferDirect(D,null,x,h,b,null)}function P(A,D,x,w){let L=null;const N=x.isPointLight===!0?A.customDistanceMaterial:A.customDepthMaterial;if(N!==void 0)L=N;else if(L=x.isPointLight===!0?l:o,n.localClippingEnabled&&D.clipShadows===!0&&Array.isArray(D.clippingPlanes)&&D.clippingPlanes.length!==0||D.displacementMap&&D.displacementScale!==0||D.alphaMap&&D.alphaTest>0||D.map&&D.alphaTest>0||D.alphaToCoverage===!0){const k=L.uuid,q=D.uuid;let H=c[k];H===void 0&&(H={},c[k]=H);let W=H[q];W===void 0&&(W=L.clone(),H[q]=W,D.addEventListener("dispose",T)),L=W}if(L.visible=D.visible,L.wireframe=D.wireframe,w===tr?L.side=D.shadowSide!==null?D.shadowSide:D.side:L.side=D.shadowSide!==null?D.shadowSide:f[D.side],L.alphaMap=D.alphaMap,L.alphaTest=D.alphaToCoverage===!0?.5:D.alphaTest,L.map=D.map,L.clipShadows=D.clipShadows,L.clippingPlanes=D.clippingPlanes,L.clipIntersection=D.clipIntersection,L.displacementMap=D.displacementMap,L.displacementScale=D.displacementScale,L.displacementBias=D.displacementBias,L.wireframeLinewidth=D.wireframeLinewidth,L.linewidth=D.linewidth,x.isPointLight===!0&&L.isMeshDistanceMaterial===!0){const k=n.properties.get(L);k.light=x}return L}function S(A,D,x,w,L){if(A.visible===!1)return;if(A.layers.test(D.layers)&&(A.isMesh||A.isLine||A.isPoints)&&(A.castShadow||A.receiveShadow&&L===tr)&&(!A.frustumCulled||A.intersectsFrustum(i))){A.modelViewMatrix.multiplyMatrices(x.matrixWorldInverse,A.matrixWorld);const q=e.update(A),H=A.material;if(Array.isArray(H)){const W=q.groups;for(let te=0,z=W.length;te<z;te++){const ie=W[te],Z=H[ie.materialIndex];if(Z&&Z.visible){const J=P(A,Z,w,L);A.onBeforeShadow(n,A,D,x,q,J,ie),n.renderBufferDirect(x,null,q,J,A,ie),A.onAfterShadow(n,A,D,x,q,J,ie)}}}else if(H.visible){const W=P(A,H,w,L);A.onBeforeShadow(n,A,D,x,q,W,null),n.renderBufferDirect(x,null,q,W,A,null),A.onAfterShadow(n,A,D,x,q,W,null)}}const k=A.children;for(let q=0,H=k.length;q<H;q++)S(k[q],D,x,w,L)}function T(A){A.target.removeEventListener("dispose",T);for(const x in c){const w=c[x],L=A.target.uuid;L in w&&(w[L].dispose(),delete w[L])}}}function IM(n,e){function t(){let O=!1;const be=new wt;let ue=null;const ye=new wt(0,0,0,0);return{setMask:function(Pe){ue!==Pe&&!O&&(n.colorMask(Pe,Pe,Pe,Pe),ue=Pe)},setLocked:function(Pe){O=Pe},setClear:function(Pe,de,Ve,Be,bt){bt===!0&&(Pe*=Be,de*=Be,Ve*=Be),be.set(Pe,de,Ve,Be),ye.equals(be)===!1&&(n.clearColor(Pe,de,Ve,Be),ye.copy(be))},reset:function(){O=!1,ue=null,ye.set(-1,0,0,0)}}}function i(){let O=!1,be=!1,ue=null,ye=null,Pe=null;return{setReversed:function(de){if(be!==de){const Ve=e.get("EXT_clip_control");de?Ve.clipControlEXT(Ve.LOWER_LEFT_EXT,Ve.ZERO_TO_ONE_EXT):Ve.clipControlEXT(Ve.LOWER_LEFT_EXT,Ve.NEGATIVE_ONE_TO_ONE_EXT),be=de;const Be=Pe;Pe=null,this.setClear(Be)}},getReversed:function(){return be},setTest:function(de){de?ae(n.DEPTH_TEST):Te(n.DEPTH_TEST)},setMask:function(de){ue!==de&&!O&&(n.depthMask(de),ue=de)},setFunc:function(de){if(be&&(de=l0[de]),ye!==de){switch(de){case hl:n.depthFunc(n.NEVER);break;case pl:n.depthFunc(n.ALWAYS);break;case ml:n.depthFunc(n.LESS);break;case Sr:n.depthFunc(n.LEQUAL);break;case gl:n.depthFunc(n.EQUAL);break;case _l:n.depthFunc(n.GEQUAL);break;case vl:n.depthFunc(n.GREATER);break;case xl:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}ye=de}},setLocked:function(de){O=de},setClear:function(de){Pe!==de&&(Pe=de,be&&(de=1-de),n.clearDepth(de))},reset:function(){O=!1,ue=null,ye=null,Pe=null,be=!1}}}function s(){let O=!1,be=null,ue=null,ye=null,Pe=null,de=null,Ve=null,Be=null,bt=null;return{setTest:function(ut){O||(ut?ae(n.STENCIL_TEST):Te(n.STENCIL_TEST))},setMask:function(ut){be!==ut&&!O&&(n.stencilMask(ut),be=ut)},setFunc:function(ut,xn,Dn){(ue!==ut||ye!==xn||Pe!==Dn)&&(n.stencilFunc(ut,xn,Dn),ue=ut,ye=xn,Pe=Dn)},setOp:function(ut,xn,Dn){(de!==ut||Ve!==xn||Be!==Dn)&&(n.stencilOp(ut,xn,Dn),de=ut,Ve=xn,Be=Dn)},setLocked:function(ut){O=ut},setClear:function(ut){bt!==ut&&(n.clearStencil(ut),bt=ut)},reset:function(){O=!1,be=null,ue=null,ye=null,Pe=null,de=null,Ve=null,Be=null,bt=null}}}const r=new t,a=new i,o=new s,l=new WeakMap,c=new WeakMap;let u={},f={},d={},h=new WeakMap,v=[],b=null,m=!1,p=null,y=null,P=null,S=null,T=null,A=null,D=null,x=new ct(0,0,0),w=0,L=!1,N=null,k=null,q=null,H=null,W=null;const te=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let z=!1,ie=0;const Z=n.getParameter(n.VERSION);Z.indexOf("WebGL")!==-1?(ie=parseFloat(/^WebGL (\d)/.exec(Z)[1]),z=ie>=1):Z.indexOf("OpenGL ES")!==-1&&(ie=parseFloat(/^OpenGL ES (\d)/.exec(Z)[1]),z=ie>=2);let J=null,le={};const ee=n.getParameter(n.SCISSOR_BOX),ve=n.getParameter(n.VIEWPORT),$e=new wt().fromArray(ee),Ge=new wt().fromArray(ve);function We(O,be,ue,ye){const Pe=new Uint8Array(4),de=n.createTexture();n.bindTexture(O,de),n.texParameteri(O,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(O,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let Ve=0;Ve<ue;Ve++)O===n.TEXTURE_3D||O===n.TEXTURE_2D_ARRAY?n.texImage3D(be,0,n.RGBA,1,1,ye,0,n.RGBA,n.UNSIGNED_BYTE,Pe):n.texImage2D(be+Ve,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,Pe);return de}const Q={};Q[n.TEXTURE_2D]=We(n.TEXTURE_2D,n.TEXTURE_2D,1),Q[n.TEXTURE_CUBE_MAP]=We(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),Q[n.TEXTURE_2D_ARRAY]=We(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),Q[n.TEXTURE_3D]=We(n.TEXTURE_3D,n.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),ae(n.DEPTH_TEST),a.setFunc(Sr),j(!1),fe(Cu),ae(n.CULL_FACE),se(fi);function ae(O){u[O]!==!0&&(n.enable(O),u[O]=!0)}function Te(O){u[O]!==!1&&(n.disable(O),u[O]=!1)}function ze(O,be){return d[O]!==be?(n.bindFramebuffer(O,be),d[O]=be,O===n.DRAW_FRAMEBUFFER&&(d[n.FRAMEBUFFER]=be),O===n.FRAMEBUFFER&&(d[n.DRAW_FRAMEBUFFER]=be),!0):!1}function De(O,be){let ue=v,ye=!1;if(O){ue=h.get(be),ue===void 0&&(ue=[],h.set(be,ue));const Pe=O.textures;if(ue.length!==Pe.length||ue[0]!==n.COLOR_ATTACHMENT0){for(let de=0,Ve=Pe.length;de<Ve;de++)ue[de]=n.COLOR_ATTACHMENT0+de;ue.length=Pe.length,ye=!0}}else ue[0]!==n.BACK&&(ue[0]=n.BACK,ye=!0);ye&&n.drawBuffers(ue)}function R(O){return b!==O?(n.useProgram(O),b=O,!0):!1}const I={[Ms]:n.FUNC_ADD,[Cg]:n.FUNC_SUBTRACT,[Pg]:n.FUNC_REVERSE_SUBTRACT};I[Dg]=n.MIN,I[Lg]=n.MAX;const G={[Ig]:n.ZERO,[Ug]:n.ONE,[Ng]:n.SRC_COLOR,[Jf]:n.SRC_ALPHA,[Vg]:n.SRC_ALPHA_SATURATE,[Hg]:n.DST_COLOR,[Og]:n.DST_ALPHA,[Fg]:n.ONE_MINUS_SRC_COLOR,[Qf]:n.ONE_MINUS_SRC_ALPHA,[kg]:n.ONE_MINUS_DST_COLOR,[Bg]:n.ONE_MINUS_DST_ALPHA,[zg]:n.CONSTANT_COLOR,[Gg]:n.ONE_MINUS_CONSTANT_COLOR,[Wg]:n.CONSTANT_ALPHA,[Xg]:n.ONE_MINUS_CONSTANT_ALPHA};function se(O,be,ue,ye,Pe,de,Ve,Be,bt,ut){if(O===fi){m===!0&&(Te(n.BLEND),m=!1);return}if(m===!1&&(ae(n.BLEND),m=!0),O!==Rg){if(O!==p||ut!==L){if((y!==Ms||T!==Ms)&&(n.blendEquation(n.FUNC_ADD),y=Ms,T=Ms),ut)switch(O){case dr:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case ii:n.blendFunc(n.ONE,n.ONE);break;case Pu:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Du:n.blendFuncSeparate(n.DST_COLOR,n.ONE_MINUS_SRC_ALPHA,n.ZERO,n.ONE);break;default:lt("WebGLState: Invalid blending: ",O);break}else switch(O){case dr:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case ii:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE,n.ONE,n.ONE);break;case Pu:lt("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Du:lt("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:lt("WebGLState: Invalid blending: ",O);break}P=null,S=null,A=null,D=null,x.set(0,0,0),w=0,p=O,L=ut}return}Pe=Pe||be,de=de||ue,Ve=Ve||ye,(be!==y||Pe!==T)&&(n.blendEquationSeparate(I[be],I[Pe]),y=be,T=Pe),(ue!==P||ye!==S||de!==A||Ve!==D)&&(n.blendFuncSeparate(G[ue],G[ye],G[de],G[Ve]),P=ue,S=ye,A=de,D=Ve),(Be.equals(x)===!1||bt!==w)&&(n.blendColor(Be.r,Be.g,Be.b,bt),x.copy(Be),w=bt),p=O,L=!1}function re(O,be){O.side===ci?Te(n.CULL_FACE):ae(n.CULL_FACE);let ue=O.side===an;be&&(ue=!ue),j(ue),O.blending===dr&&O.transparent===!1?se(fi):se(O.blending,O.blendEquation,O.blendSrc,O.blendDst,O.blendEquationAlpha,O.blendSrcAlpha,O.blendDstAlpha,O.blendColor,O.blendAlpha,O.premultipliedAlpha),a.setFunc(O.depthFunc),a.setTest(O.depthTest),a.setMask(O.depthWrite),r.setMask(O.colorWrite);const ye=O.stencilWrite;o.setTest(ye),ye&&(o.setMask(O.stencilWriteMask),o.setFunc(O.stencilFunc,O.stencilRef,O.stencilFuncMask),o.setOp(O.stencilFail,O.stencilZFail,O.stencilZPass)),pe(O.polygonOffset,O.polygonOffsetFactor,O.polygonOffsetUnits),O.alphaToCoverage===!0?ae(n.SAMPLE_ALPHA_TO_COVERAGE):Te(n.SAMPLE_ALPHA_TO_COVERAGE)}function j(O){N!==O&&(O?n.frontFace(n.CW):n.frontFace(n.CCW),N=O)}function fe(O){O!==Tg?(ae(n.CULL_FACE),O!==k&&(O===Cu?n.cullFace(n.BACK):O===Ag?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):Te(n.CULL_FACE),k=O}function he(O){O!==q&&(z&&n.lineWidth(O),q=O)}function pe(O,be,ue){O?(ae(n.POLYGON_OFFSET_FILL),(H!==be||W!==ue)&&(H=be,W=ue,a.getReversed()&&(be=-be),n.polygonOffset(be,ue))):Te(n.POLYGON_OFFSET_FILL)}function oe(O){O?ae(n.SCISSOR_TEST):Te(n.SCISSOR_TEST)}function Ce(O){O===void 0&&(O=n.TEXTURE0+te-1),J!==O&&(n.activeTexture(O),J=O)}function C(O,be,ue){ue===void 0&&(J===null?ue=n.TEXTURE0+te-1:ue=J);let ye=le[ue];ye===void 0&&(ye={type:void 0,texture:void 0},le[ue]=ye),(ye.type!==O||ye.texture!==be)&&(J!==ue&&(n.activeTexture(ue),J=ue),n.bindTexture(O,be||Q[O]),ye.type=O,ye.texture=be)}function Le(){const O=le[J];O!==void 0&&O.type!==void 0&&(n.bindTexture(O.type,null),O.type=void 0,O.texture=void 0)}function Ee(){try{n.compressedTexImage2D(...arguments)}catch(O){lt("WebGLState:",O)}}function E(){try{n.compressedTexImage3D(...arguments)}catch(O){lt("WebGLState:",O)}}function g(){try{n.texSubImage2D(...arguments)}catch(O){lt("WebGLState:",O)}}function U(){try{n.texSubImage3D(...arguments)}catch(O){lt("WebGLState:",O)}}function V(){try{n.compressedTexSubImage2D(...arguments)}catch(O){lt("WebGLState:",O)}}function K(){try{n.compressedTexSubImage3D(...arguments)}catch(O){lt("WebGLState:",O)}}function me(){try{n.texStorage2D(...arguments)}catch(O){lt("WebGLState:",O)}}function _e(){try{n.texStorage3D(...arguments)}catch(O){lt("WebGLState:",O)}}function ne(){try{n.texImage2D(...arguments)}catch(O){lt("WebGLState:",O)}}function ce(){try{n.texImage3D(...arguments)}catch(O){lt("WebGLState:",O)}}function ge(O){return f[O]!==void 0?f[O]:n.getParameter(O)}function Ie(O,be){f[O]!==be&&(n.pixelStorei(O,be),f[O]=be)}function Me(O){$e.equals(O)===!1&&(n.scissor(O.x,O.y,O.z,O.w),$e.copy(O))}function Se(O){Ge.equals(O)===!1&&(n.viewport(O.x,O.y,O.z,O.w),Ge.copy(O))}function ke(O,be){let ue=c.get(be);ue===void 0&&(ue=new WeakMap,c.set(be,ue));let ye=ue.get(O);ye===void 0&&(ye=n.getUniformBlockIndex(be,O.name),ue.set(O,ye))}function Ye(O,be){const ye=c.get(be).get(O);l.get(be)!==ye&&(n.uniformBlockBinding(be,ye,O.__bindingPointIndex),l.set(be,ye))}function Qe(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),a.setReversed(!1),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),n.pixelStorei(n.PACK_ALIGNMENT,4),n.pixelStorei(n.UNPACK_ALIGNMENT,4),n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,!1),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,n.BROWSER_DEFAULT_WEBGL),n.pixelStorei(n.PACK_ROW_LENGTH,0),n.pixelStorei(n.PACK_SKIP_PIXELS,0),n.pixelStorei(n.PACK_SKIP_ROWS,0),n.pixelStorei(n.UNPACK_ROW_LENGTH,0),n.pixelStorei(n.UNPACK_IMAGE_HEIGHT,0),n.pixelStorei(n.UNPACK_SKIP_PIXELS,0),n.pixelStorei(n.UNPACK_SKIP_ROWS,0),n.pixelStorei(n.UNPACK_SKIP_IMAGES,0),u={},f={},J=null,le={},d={},h=new WeakMap,v=[],b=null,m=!1,p=null,y=null,P=null,S=null,T=null,A=null,D=null,x=new ct(0,0,0),w=0,L=!1,N=null,k=null,q=null,H=null,W=null,$e.set(0,0,n.canvas.width,n.canvas.height),Ge.set(0,0,n.canvas.width,n.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:ae,disable:Te,bindFramebuffer:ze,drawBuffers:De,useProgram:R,setBlending:se,setMaterial:re,setFlipSided:j,setCullFace:fe,setLineWidth:he,setPolygonOffset:pe,setScissorTest:oe,activeTexture:Ce,bindTexture:C,unbindTexture:Le,compressedTexImage2D:Ee,compressedTexImage3D:E,texImage2D:ne,texImage3D:ce,pixelStorei:Ie,getParameter:ge,updateUBOMapping:ke,uniformBlockBinding:Ye,texStorage2D:me,texStorage3D:_e,texSubImage2D:g,texSubImage3D:U,compressedTexSubImage2D:V,compressedTexSubImage3D:K,scissor:Me,viewport:Se,reset:Qe}}function UM(n,e,t,i,s,r,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new rt,u=new WeakMap,f=new Set;let d;const h=new WeakMap;let v=!1;try{v=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function b(E,g){return v?new OffscreenCanvas(E,g):Ua("canvas")}function m(E,g,U){let V=1;const K=Ee(E);if((K.width>U||K.height>U)&&(V=U/Math.max(K.width,K.height)),V<1)if(typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&E instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&E instanceof ImageBitmap||typeof VideoFrame<"u"&&E instanceof VideoFrame){const me=Math.floor(V*K.width),_e=Math.floor(V*K.height);d===void 0&&(d=b(me,_e));const ne=g?b(me,_e):d;return ne.width=me,ne.height=_e,ne.getContext("2d").drawImage(E,0,0,me,_e),Ke("WebGLRenderer: Texture has been resized from ("+K.width+"x"+K.height+") to ("+me+"x"+_e+")."),ne}else return"data"in E&&Ke("WebGLRenderer: Image in DataTexture is too big ("+K.width+"x"+K.height+")."),E;return E}function p(E){return E.generateMipmaps}function y(E){n.generateMipmap(E)}function P(E){return E.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:E.isWebGL3DRenderTarget?n.TEXTURE_3D:E.isWebGLArrayRenderTarget||E.isCompressedArrayTexture?n.TEXTURE_2D_ARRAY:n.TEXTURE_2D}function S(E,g,U,V,K,me=!1){if(E!==null){if(n[E]!==void 0)return n[E];Ke("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+E+"'")}let _e;V&&(_e=e.get("EXT_texture_norm16"),_e||Ke("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let ne=g;if(g===n.RED&&(U===n.FLOAT&&(ne=n.R32F),U===n.HALF_FLOAT&&(ne=n.R16F),U===n.UNSIGNED_BYTE&&(ne=n.R8),U===n.UNSIGNED_SHORT&&_e&&(ne=_e.R16_EXT),U===n.SHORT&&_e&&(ne=_e.R16_SNORM_EXT)),g===n.RED_INTEGER&&(U===n.UNSIGNED_BYTE&&(ne=n.R8UI),U===n.UNSIGNED_SHORT&&(ne=n.R16UI),U===n.UNSIGNED_INT&&(ne=n.R32UI),U===n.BYTE&&(ne=n.R8I),U===n.SHORT&&(ne=n.R16I),U===n.INT&&(ne=n.R32I)),g===n.RG&&(U===n.FLOAT&&(ne=n.RG32F),U===n.HALF_FLOAT&&(ne=n.RG16F),U===n.UNSIGNED_BYTE&&(ne=n.RG8),U===n.UNSIGNED_SHORT&&_e&&(ne=_e.RG16_EXT),U===n.SHORT&&_e&&(ne=_e.RG16_SNORM_EXT)),g===n.RG_INTEGER&&(U===n.UNSIGNED_BYTE&&(ne=n.RG8UI),U===n.UNSIGNED_SHORT&&(ne=n.RG16UI),U===n.UNSIGNED_INT&&(ne=n.RG32UI),U===n.BYTE&&(ne=n.RG8I),U===n.SHORT&&(ne=n.RG16I),U===n.INT&&(ne=n.RG32I)),g===n.RGB_INTEGER&&(U===n.UNSIGNED_BYTE&&(ne=n.RGB8UI),U===n.UNSIGNED_SHORT&&(ne=n.RGB16UI),U===n.UNSIGNED_INT&&(ne=n.RGB32UI),U===n.BYTE&&(ne=n.RGB8I),U===n.SHORT&&(ne=n.RGB16I),U===n.INT&&(ne=n.RGB32I)),g===n.RGBA_INTEGER&&(U===n.UNSIGNED_BYTE&&(ne=n.RGBA8UI),U===n.UNSIGNED_SHORT&&(ne=n.RGBA16UI),U===n.UNSIGNED_INT&&(ne=n.RGBA32UI),U===n.BYTE&&(ne=n.RGBA8I),U===n.SHORT&&(ne=n.RGBA16I),U===n.INT&&(ne=n.RGBA32I)),g===n.RGB&&(U===n.UNSIGNED_SHORT&&_e&&(ne=_e.RGB16_EXT),U===n.SHORT&&_e&&(ne=_e.RGB16_SNORM_EXT),U===n.UNSIGNED_INT_5_9_9_9_REV&&(ne=n.RGB9_E5),U===n.UNSIGNED_INT_10F_11F_11F_REV&&(ne=n.R11F_G11F_B10F)),g===n.RGBA){const ce=me?La:st.getTransfer(K);U===n.FLOAT&&(ne=n.RGBA32F),U===n.HALF_FLOAT&&(ne=n.RGBA16F),U===n.UNSIGNED_BYTE&&(ne=ce===ht?n.SRGB8_ALPHA8:n.RGBA8),U===n.UNSIGNED_SHORT&&_e&&(ne=_e.RGBA16_EXT),U===n.SHORT&&_e&&(ne=_e.RGBA16_SNORM_EXT),U===n.UNSIGNED_SHORT_4_4_4_4&&(ne=n.RGBA4),U===n.UNSIGNED_SHORT_5_5_5_1&&(ne=n.RGB5_A1)}return(ne===n.R16F||ne===n.R32F||ne===n.RG16F||ne===n.RG32F||ne===n.RGBA16F||ne===n.RGBA32F)&&e.get("EXT_color_buffer_float"),ne}function T(E,g){let U;return E?g===null||g===Yn||g===br?U=n.DEPTH24_STENCIL8:g===Vn?U=n.DEPTH32F_STENCIL8:g===Mr&&(U=n.DEPTH24_STENCIL8,Ke("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):g===null||g===Yn||g===br?U=n.DEPTH_COMPONENT24:g===Vn?U=n.DEPTH_COMPONENT32F:g===Mr&&(U=n.DEPTH_COMPONENT16),U}function A(E,g){return p(E)===!0||E.isFramebufferTexture&&E.minFilter!==Bt&&E.minFilter!==Xt?Math.log2(Math.max(g.width,g.height))+1:E.mipmaps!==void 0&&E.mipmaps.length>0?E.mipmaps.length:E.isCompressedTexture&&Array.isArray(E.image)?g.mipmaps.length:1}function D(E){const g=E.target;g.removeEventListener("dispose",D),w(g),g.isVideoTexture&&u.delete(g),g.isHTMLTexture&&f.delete(g)}function x(E){const g=E.target;g.removeEventListener("dispose",x),N(g)}function w(E){const g=i.get(E);if(g.__webglInit===void 0)return;const U=E.source,V=h.get(U);if(V){const K=V[g.__cacheKey];K.usedTimes--,K.usedTimes===0&&L(E),Object.keys(V).length===0&&h.delete(U)}i.remove(E)}function L(E){const g=i.get(E);n.deleteTexture(g.__webglTexture);const U=E.source,V=h.get(U);delete V[g.__cacheKey],a.memory.textures--}function N(E){const g=i.get(E);if(E.depthTexture&&(E.depthTexture.dispose(),i.remove(E.depthTexture)),E.isWebGLCubeRenderTarget)for(let V=0;V<6;V++){if(Array.isArray(g.__webglFramebuffer[V]))for(let K=0;K<g.__webglFramebuffer[V].length;K++)n.deleteFramebuffer(g.__webglFramebuffer[V][K]);else n.deleteFramebuffer(g.__webglFramebuffer[V]);g.__webglDepthbuffer&&n.deleteRenderbuffer(g.__webglDepthbuffer[V])}else{if(Array.isArray(g.__webglFramebuffer))for(let V=0;V<g.__webglFramebuffer.length;V++)n.deleteFramebuffer(g.__webglFramebuffer[V]);else n.deleteFramebuffer(g.__webglFramebuffer);if(g.__webglDepthbuffer&&n.deleteRenderbuffer(g.__webglDepthbuffer),g.__webglMultisampledFramebuffer&&n.deleteFramebuffer(g.__webglMultisampledFramebuffer),g.__webglColorRenderbuffer)for(let V=0;V<g.__webglColorRenderbuffer.length;V++)g.__webglColorRenderbuffer[V]&&n.deleteRenderbuffer(g.__webglColorRenderbuffer[V]);g.__webglDepthRenderbuffer&&n.deleteRenderbuffer(g.__webglDepthRenderbuffer)}const U=E.textures;for(let V=0,K=U.length;V<K;V++){const me=i.get(U[V]);me.__webglTexture&&(n.deleteTexture(me.__webglTexture),a.memory.textures--),i.remove(U[V])}i.remove(E)}let k=0;function q(){k=0}function H(){return k}function W(E){k=E}function te(){const E=k;return E>=s.maxTextures&&Ke("WebGLTextures: Trying to use "+(E+1)+" texture units while this GPU supports only "+s.maxTextures),k+=1,E}function z(E){const g=[];return g.push(E.wrapS),g.push(E.wrapT),g.push(E.wrapR||0),g.push(E.magFilter),g.push(E.minFilter),g.push(E.anisotropy),g.push(E.internalFormat),g.push(E.format),g.push(E.type),g.push(E.generateMipmaps),g.push(E.premultiplyAlpha),g.push(E.flipY),g.push(E.unpackAlignment),g.push(E.colorSpace),g.join()}function ie(E,g){const U=i.get(E);if(E.isVideoTexture&&C(E),E.isRenderTargetTexture===!1&&E.isExternalTexture!==!0&&E.version>0&&U.__version!==E.version){const V=E.image;if(V===null)Ke("WebGLRenderer: Texture marked for update but no image data found.");else if(V.complete===!1)Ke("WebGLRenderer: Texture marked for update but image is incomplete");else{Te(U,E,g);return}}else E.isExternalTexture&&(U.__webglTexture=E.sourceTexture?E.sourceTexture:null);t.bindTexture(n.TEXTURE_2D,U.__webglTexture,n.TEXTURE0+g)}function Z(E,g){const U=i.get(E);if(E.isRenderTargetTexture===!1&&E.version>0&&U.__version!==E.version){Te(U,E,g);return}else E.isExternalTexture&&(U.__webglTexture=E.sourceTexture?E.sourceTexture:null);t.bindTexture(n.TEXTURE_2D_ARRAY,U.__webglTexture,n.TEXTURE0+g)}function J(E,g){const U=i.get(E);if(E.isRenderTargetTexture===!1&&E.version>0&&U.__version!==E.version){Te(U,E,g);return}t.bindTexture(n.TEXTURE_3D,U.__webglTexture,n.TEXTURE0+g)}function le(E,g){const U=i.get(E);if(E.isCubeDepthTexture!==!0&&E.version>0&&U.__version!==E.version){ze(U,E,g);return}t.bindTexture(n.TEXTURE_CUBE_MAP,U.__webglTexture,n.TEXTURE0+g)}const ee={[Sl]:n.REPEAT,[ui]:n.CLAMP_TO_EDGE,[Ml]:n.MIRRORED_REPEAT},ve={[Bt]:n.NEAREST,[Kg]:n.NEAREST_MIPMAP_NEAREST,[Hr]:n.NEAREST_MIPMAP_LINEAR,[Xt]:n.LINEAR,[So]:n.LINEAR_MIPMAP_NEAREST,[Ki]:n.LINEAR_MIPMAP_LINEAR},$e={[Qg]:n.NEVER,[i0]:n.ALWAYS,[jg]:n.LESS,[Rc]:n.LEQUAL,[e0]:n.EQUAL,[Cc]:n.GEQUAL,[t0]:n.GREATER,[n0]:n.NOTEQUAL};function Ge(E,g){if(g.type===Vn&&e.has("OES_texture_float_linear")===!1&&(g.magFilter===Xt||g.magFilter===So||g.magFilter===Hr||g.magFilter===Ki||g.minFilter===Xt||g.minFilter===So||g.minFilter===Hr||g.minFilter===Ki)&&Ke("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(E,n.TEXTURE_WRAP_S,ee[g.wrapS]),n.texParameteri(E,n.TEXTURE_WRAP_T,ee[g.wrapT]),(E===n.TEXTURE_3D||E===n.TEXTURE_2D_ARRAY)&&n.texParameteri(E,n.TEXTURE_WRAP_R,ee[g.wrapR]),n.texParameteri(E,n.TEXTURE_MAG_FILTER,ve[g.magFilter]),n.texParameteri(E,n.TEXTURE_MIN_FILTER,ve[g.minFilter]),g.compareFunction&&(n.texParameteri(E,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(E,n.TEXTURE_COMPARE_FUNC,$e[g.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(g.magFilter===Bt||g.minFilter!==Hr&&g.minFilter!==Ki||g.type===Vn&&e.has("OES_texture_float_linear")===!1)return;if(g.anisotropy>1||i.get(g).__currentAnisotropy){const U=e.get("EXT_texture_filter_anisotropic");n.texParameterf(E,U.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(g.anisotropy,s.getMaxAnisotropy())),i.get(g).__currentAnisotropy=g.anisotropy}}}function We(E,g){let U=!1;E.__webglInit===void 0&&(E.__webglInit=!0,g.addEventListener("dispose",D));const V=g.source;let K=h.get(V);K===void 0&&(K={},h.set(V,K));const me=z(g);if(me!==E.__cacheKey){K[me]===void 0&&(K[me]={texture:n.createTexture(),usedTimes:0},a.memory.textures++,U=!0),K[me].usedTimes++;const _e=K[E.__cacheKey];_e!==void 0&&(K[E.__cacheKey].usedTimes--,_e.usedTimes===0&&L(g)),E.__cacheKey=me,E.__webglTexture=K[me].texture}return U}function Q(E,g,U){return Math.floor(Math.floor(E/U)/g)}function ae(E,g,U,V){const me=E.updateRanges;if(me.length===0)t.texSubImage2D(n.TEXTURE_2D,0,0,0,g.width,g.height,U,V,g.data);else{me.sort((Ie,Me)=>Ie.start-Me.start);let _e=0;for(let Ie=1;Ie<me.length;Ie++){const Me=me[_e],Se=me[Ie],ke=Me.start+Me.count,Ye=Q(Se.start,g.width,4),Qe=Q(Me.start,g.width,4);Se.start<=ke+1&&Ye===Qe&&Q(Se.start+Se.count-1,g.width,4)===Ye?Me.count=Math.max(Me.count,Se.start+Se.count-Me.start):(++_e,me[_e]=Se)}me.length=_e+1;const ne=t.getParameter(n.UNPACK_ROW_LENGTH),ce=t.getParameter(n.UNPACK_SKIP_PIXELS),ge=t.getParameter(n.UNPACK_SKIP_ROWS);t.pixelStorei(n.UNPACK_ROW_LENGTH,g.width);for(let Ie=0,Me=me.length;Ie<Me;Ie++){const Se=me[Ie],ke=Math.floor(Se.start/4),Ye=Math.ceil(Se.count/4),Qe=ke%g.width,O=Math.floor(ke/g.width),be=Ye,ue=1;t.pixelStorei(n.UNPACK_SKIP_PIXELS,Qe),t.pixelStorei(n.UNPACK_SKIP_ROWS,O),t.texSubImage2D(n.TEXTURE_2D,0,Qe,O,be,ue,U,V,g.data)}E.clearUpdateRanges(),t.pixelStorei(n.UNPACK_ROW_LENGTH,ne),t.pixelStorei(n.UNPACK_SKIP_PIXELS,ce),t.pixelStorei(n.UNPACK_SKIP_ROWS,ge)}}function Te(E,g,U){let V=n.TEXTURE_2D;(g.isDataArrayTexture||g.isCompressedArrayTexture)&&(V=n.TEXTURE_2D_ARRAY),g.isData3DTexture&&(V=n.TEXTURE_3D);const K=We(E,g),me=g.source;t.bindTexture(V,E.__webglTexture,n.TEXTURE0+U);const _e=i.get(me);if(me.version!==_e.__version||K===!0){if(t.activeTexture(n.TEXTURE0+U),(typeof ImageBitmap<"u"&&g.image instanceof ImageBitmap)===!1){const ue=st.getPrimaries(st.workingColorSpace),ye=g.colorSpace===Ii?null:st.getPrimaries(g.colorSpace),Pe=g.colorSpace===Ii||ue===ye?n.NONE:n.BROWSER_DEFAULT_WEBGL;t.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,g.flipY),t.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),t.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Pe)}t.pixelStorei(n.UNPACK_ALIGNMENT,g.unpackAlignment);let ce=m(g.image,!1,s.maxTextureSize);ce=Le(g,ce);const ge=r.convert(g.format,g.colorSpace),Ie=r.convert(g.type);let Me=S(g.internalFormat,ge,Ie,g.normalized,g.colorSpace,g.isVideoTexture);Ge(V,g);let Se;const ke=g.mipmaps,Ye=g.isVideoTexture!==!0,Qe=_e.__version===void 0||K===!0,O=me.dataReady,be=A(g,ce);if(g.isDepthTexture)Me=T(g.format===Zi,g.type),Qe&&(Ye?t.texStorage2D(n.TEXTURE_2D,1,Me,ce.width,ce.height):t.texImage2D(n.TEXTURE_2D,0,Me,ce.width,ce.height,0,ge,Ie,null));else if(g.isDataTexture)if(ke.length>0){Ye&&Qe&&t.texStorage2D(n.TEXTURE_2D,be,Me,ke[0].width,ke[0].height);for(let ue=0,ye=ke.length;ue<ye;ue++)Se=ke[ue],Ye?O&&t.texSubImage2D(n.TEXTURE_2D,ue,0,0,Se.width,Se.height,ge,Ie,Se.data):t.texImage2D(n.TEXTURE_2D,ue,Me,Se.width,Se.height,0,ge,Ie,Se.data);g.generateMipmaps=!1}else Ye?(Qe&&t.texStorage2D(n.TEXTURE_2D,be,Me,ce.width,ce.height),O&&ae(g,ce,ge,Ie)):t.texImage2D(n.TEXTURE_2D,0,Me,ce.width,ce.height,0,ge,Ie,ce.data);else if(g.isCompressedTexture)if(g.isCompressedArrayTexture){Ye&&Qe&&t.texStorage3D(n.TEXTURE_2D_ARRAY,be,Me,ke[0].width,ke[0].height,ce.depth);for(let ue=0,ye=ke.length;ue<ye;ue++)if(Se=ke[ue],g.format!==Tn)if(ge!==null)if(Ye){if(O)if(g.layerUpdates.size>0){const Pe=ld(Se.width,Se.height,g.format,g.type);for(const de of g.layerUpdates){const Ve=Se.data.subarray(de*Pe/Se.data.BYTES_PER_ELEMENT,(de+1)*Pe/Se.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,ue,0,0,de,Se.width,Se.height,1,ge,Ve)}}else t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,ue,0,0,0,Se.width,Se.height,ce.depth,ge,Se.data)}else t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,ue,Me,Se.width,Se.height,ce.depth,0,Se.data,0,0);else Ke("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ye?O&&t.texSubImage3D(n.TEXTURE_2D_ARRAY,ue,0,0,0,Se.width,Se.height,ce.depth,ge,Ie,Se.data):t.texImage3D(n.TEXTURE_2D_ARRAY,ue,Me,Se.width,Se.height,ce.depth,0,ge,Ie,Se.data);g.layerUpdates.size>0&&g.clearLayerUpdates()}else{Ye&&Qe&&t.texStorage2D(n.TEXTURE_2D,be,Me,ke[0].width,ke[0].height);for(let ue=0,ye=ke.length;ue<ye;ue++)Se=ke[ue],g.format!==Tn?ge!==null?Ye?O&&t.compressedTexSubImage2D(n.TEXTURE_2D,ue,0,0,Se.width,Se.height,ge,Se.data):t.compressedTexImage2D(n.TEXTURE_2D,ue,Me,Se.width,Se.height,0,Se.data):Ke("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ye?O&&t.texSubImage2D(n.TEXTURE_2D,ue,0,0,Se.width,Se.height,ge,Ie,Se.data):t.texImage2D(n.TEXTURE_2D,ue,Me,Se.width,Se.height,0,ge,Ie,Se.data)}else if(g.isDataArrayTexture)if(Ye){if(Qe&&t.texStorage3D(n.TEXTURE_2D_ARRAY,be,Me,ce.width,ce.height,ce.depth),O)if(g.layerUpdates.size>0){const ue=ld(ce.width,ce.height,g.format,g.type);for(const ye of g.layerUpdates){const Pe=ce.data.subarray(ye*ue/ce.data.BYTES_PER_ELEMENT,(ye+1)*ue/ce.data.BYTES_PER_ELEMENT);t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,ye,ce.width,ce.height,1,ge,Ie,Pe)}g.clearLayerUpdates()}else t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,ce.width,ce.height,ce.depth,ge,Ie,ce.data)}else t.texImage3D(n.TEXTURE_2D_ARRAY,0,Me,ce.width,ce.height,ce.depth,0,ge,Ie,ce.data);else if(g.isData3DTexture)Ye?(Qe&&t.texStorage3D(n.TEXTURE_3D,be,Me,ce.width,ce.height,ce.depth),O&&t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,ce.width,ce.height,ce.depth,ge,Ie,ce.data)):t.texImage3D(n.TEXTURE_3D,0,Me,ce.width,ce.height,ce.depth,0,ge,Ie,ce.data);else if(g.isFramebufferTexture){if(Qe)if(Ye)t.texStorage2D(n.TEXTURE_2D,be,Me,ce.width,ce.height);else{let ue=ce.width,ye=ce.height;for(let Pe=0;Pe<be;Pe++)t.texImage2D(n.TEXTURE_2D,Pe,Me,ue,ye,0,ge,Ie,null),ue>>=1,ye>>=1}}else if(g.isHTMLTexture){if("texElementImage2D"in n){const ue=n.canvas;if(ue.hasAttribute("layoutsubtree")||ue.setAttribute("layoutsubtree","true"),ce.parentNode!==ue){ue.appendChild(ce),f.add(g),ue.onpaint=ye=>{const Pe=ye.changedElements;for(const de of f)Pe.includes(de.image)&&(de.needsUpdate=!0)},ue.requestPaint();return}if(n.texElementImage2D.length===3)n.texElementImage2D(n.TEXTURE_2D,n.RGBA8,ce);else{const Pe=n.RGBA,de=n.RGBA,Ve=n.UNSIGNED_BYTE;n.texElementImage2D(n.TEXTURE_2D,0,Pe,de,Ve,ce)}n.texParameteri(n.TEXTURE_2D,n.TEXTURE_MIN_FILTER,n.LINEAR),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_WRAP_S,n.CLAMP_TO_EDGE),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_WRAP_T,n.CLAMP_TO_EDGE)}}else if(ke.length>0){if(Ye&&Qe){const ue=Ee(ke[0]);t.texStorage2D(n.TEXTURE_2D,be,Me,ue.width,ue.height)}for(let ue=0,ye=ke.length;ue<ye;ue++)Se=ke[ue],Ye?O&&t.texSubImage2D(n.TEXTURE_2D,ue,0,0,ge,Ie,Se):t.texImage2D(n.TEXTURE_2D,ue,Me,ge,Ie,Se);g.generateMipmaps=!1}else if(Ye){if(Qe){const ue=Ee(ce);t.texStorage2D(n.TEXTURE_2D,be,Me,ue.width,ue.height)}O&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,ge,Ie,ce)}else t.texImage2D(n.TEXTURE_2D,0,Me,ge,Ie,ce);p(g)&&y(V),_e.__version=me.version,g.onUpdate&&g.onUpdate(g)}E.__version=g.version}function ze(E,g,U){if(g.image.length!==6)return;const V=We(E,g),K=g.source;t.bindTexture(n.TEXTURE_CUBE_MAP,E.__webglTexture,n.TEXTURE0+U);const me=i.get(K);if(K.version!==me.__version||V===!0){t.activeTexture(n.TEXTURE0+U);const _e=st.getPrimaries(st.workingColorSpace),ne=g.colorSpace===Ii?null:st.getPrimaries(g.colorSpace),ce=g.colorSpace===Ii||_e===ne?n.NONE:n.BROWSER_DEFAULT_WEBGL;t.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,g.flipY),t.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),t.pixelStorei(n.UNPACK_ALIGNMENT,g.unpackAlignment),t.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,ce);const ge=g.isCompressedTexture||g.image[0].isCompressedTexture,Ie=g.image[0]&&g.image[0].isDataTexture,Me=[];for(let de=0;de<6;de++)!ge&&!Ie?Me[de]=m(g.image[de],!0,s.maxCubemapSize):Me[de]=Ie?g.image[de].image:g.image[de],Me[de]=Le(g,Me[de]);const Se=Me[0],ke=r.convert(g.format,g.colorSpace),Ye=r.convert(g.type),Qe=S(g.internalFormat,ke,Ye,g.normalized,g.colorSpace),O=g.isVideoTexture!==!0,be=me.__version===void 0||V===!0,ue=K.dataReady;let ye=A(g,Se);Ge(n.TEXTURE_CUBE_MAP,g);let Pe;if(ge){O&&be&&t.texStorage2D(n.TEXTURE_CUBE_MAP,ye,Qe,Se.width,Se.height);for(let de=0;de<6;de++){Pe=Me[de].mipmaps;for(let Ve=0;Ve<Pe.length;Ve++){const Be=Pe[Ve];g.format!==Tn?ke!==null?O?ue&&t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+de,Ve,0,0,Be.width,Be.height,ke,Be.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+de,Ve,Qe,Be.width,Be.height,0,Be.data):Ke("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):O?ue&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+de,Ve,0,0,Be.width,Be.height,ke,Ye,Be.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+de,Ve,Qe,Be.width,Be.height,0,ke,Ye,Be.data)}}}else{if(Pe=g.mipmaps,O&&be){Pe.length>0&&ye++;const de=Ee(Me[0]);t.texStorage2D(n.TEXTURE_CUBE_MAP,ye,Qe,de.width,de.height)}for(let de=0;de<6;de++)if(Ie){O?ue&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+de,0,0,0,Me[de].width,Me[de].height,ke,Ye,Me[de].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+de,0,Qe,Me[de].width,Me[de].height,0,ke,Ye,Me[de].data);for(let Ve=0;Ve<Pe.length;Ve++){const bt=Pe[Ve].image[de].image;O?ue&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+de,Ve+1,0,0,bt.width,bt.height,ke,Ye,bt.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+de,Ve+1,Qe,bt.width,bt.height,0,ke,Ye,bt.data)}}else{O?ue&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+de,0,0,0,ke,Ye,Me[de]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+de,0,Qe,ke,Ye,Me[de]);for(let Ve=0;Ve<Pe.length;Ve++){const Be=Pe[Ve];O?ue&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+de,Ve+1,0,0,ke,Ye,Be.image[de]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+de,Ve+1,Qe,ke,Ye,Be.image[de])}}}p(g)&&y(n.TEXTURE_CUBE_MAP),me.__version=K.version,g.onUpdate&&g.onUpdate(g)}E.__version=g.version}function De(E,g,U,V,K,me){const _e=r.convert(U.format,U.colorSpace),ne=r.convert(U.type),ce=S(U.internalFormat,_e,ne,U.normalized,U.colorSpace),ge=i.get(g),Ie=i.get(U);if(Ie.__renderTarget=g,!ge.__hasExternalTextures){const Me=Math.max(1,g.width>>me),Se=Math.max(1,g.height>>me);K===n.TEXTURE_3D||K===n.TEXTURE_2D_ARRAY?t.texImage3D(K,me,ce,Me,Se,g.depth,0,_e,ne,null):t.texImage2D(K,me,ce,Me,Se,0,_e,ne,null)}t.bindFramebuffer(n.FRAMEBUFFER,E),Ce(g)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,V,K,Ie.__webglTexture,0,oe(g)):(K===n.TEXTURE_2D||K>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&K<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,V,K,Ie.__webglTexture,me),t.bindFramebuffer(n.FRAMEBUFFER,null)}function R(E,g,U){if(n.bindRenderbuffer(n.RENDERBUFFER,E),g.depthBuffer){const V=g.depthTexture,K=V&&V.isDepthTexture?V.type:null,me=T(g.stencilBuffer,K),_e=g.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;Ce(g)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,oe(g),me,g.width,g.height):U?n.renderbufferStorageMultisample(n.RENDERBUFFER,oe(g),me,g.width,g.height):n.renderbufferStorage(n.RENDERBUFFER,me,g.width,g.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,_e,n.RENDERBUFFER,E)}else{const V=g.textures;for(let K=0;K<V.length;K++){const me=V[K],_e=r.convert(me.format,me.colorSpace),ne=r.convert(me.type),ce=S(me.internalFormat,_e,ne,me.normalized,me.colorSpace);Ce(g)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,oe(g),ce,g.width,g.height):U?n.renderbufferStorageMultisample(n.RENDERBUFFER,oe(g),ce,g.width,g.height):n.renderbufferStorage(n.RENDERBUFFER,ce,g.width,g.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function I(E,g,U){const V=g.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(n.FRAMEBUFFER,E),!(g.depthTexture&&g.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");const K=i.get(g.depthTexture);if(K.__renderTarget=g,(!K.__webglTexture||g.depthTexture.image.width!==g.width||g.depthTexture.image.height!==g.height)&&(g.depthTexture.image.width=g.width,g.depthTexture.image.height=g.height,g.depthTexture.needsUpdate=!0),V){if(K.__webglInit===void 0&&(K.__webglInit=!0,g.depthTexture.addEventListener("dispose",D)),K.__webglTexture===void 0){K.__webglTexture=n.createTexture(),t.bindTexture(n.TEXTURE_CUBE_MAP,K.__webglTexture),Ge(n.TEXTURE_CUBE_MAP,g.depthTexture);const ge=r.convert(g.depthTexture.format),Ie=r.convert(g.depthTexture.type);let Me;g.depthTexture.format===xi?Me=n.DEPTH_COMPONENT24:g.depthTexture.format===Zi&&(Me=n.DEPTH24_STENCIL8);for(let Se=0;Se<6;Se++)n.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Se,0,Me,g.width,g.height,0,ge,Ie,null)}}else ie(g.depthTexture,0);const me=K.__webglTexture,_e=oe(g),ne=V?n.TEXTURE_CUBE_MAP_POSITIVE_X+U:n.TEXTURE_2D,ce=g.depthTexture.format===Zi?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;if(g.depthTexture.format===xi)Ce(g)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,ce,ne,me,0,_e):n.framebufferTexture2D(n.FRAMEBUFFER,ce,ne,me,0);else if(g.depthTexture.format===Zi)Ce(g)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,ce,ne,me,0,_e):n.framebufferTexture2D(n.FRAMEBUFFER,ce,ne,me,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function G(E){const g=i.get(E),U=E.isWebGLCubeRenderTarget===!0;if(g.__boundDepthTexture!==E.depthTexture){const V=E.depthTexture;if(g.__depthDisposeCallback&&g.__depthDisposeCallback(),V){const K=()=>{delete g.__boundDepthTexture,delete g.__depthDisposeCallback,V.removeEventListener("dispose",K)};V.addEventListener("dispose",K),g.__depthDisposeCallback=K}g.__boundDepthTexture=V}if(E.depthTexture&&!g.__autoAllocateDepthBuffer)if(U)for(let V=0;V<6;V++)I(g.__webglFramebuffer[V],E,V);else{const V=E.texture.mipmaps;V&&V.length>0?I(g.__webglFramebuffer[0],E,0):I(g.__webglFramebuffer,E,0)}else if(U){g.__webglDepthbuffer=[];for(let V=0;V<6;V++)if(t.bindFramebuffer(n.FRAMEBUFFER,g.__webglFramebuffer[V]),g.__webglDepthbuffer[V]===void 0)g.__webglDepthbuffer[V]=n.createRenderbuffer(),R(g.__webglDepthbuffer[V],E,!1);else{const K=E.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,me=g.__webglDepthbuffer[V];n.bindRenderbuffer(n.RENDERBUFFER,me),n.framebufferRenderbuffer(n.FRAMEBUFFER,K,n.RENDERBUFFER,me)}}else{const V=E.texture.mipmaps;if(V&&V.length>0?t.bindFramebuffer(n.FRAMEBUFFER,g.__webglFramebuffer[0]):t.bindFramebuffer(n.FRAMEBUFFER,g.__webglFramebuffer),g.__webglDepthbuffer===void 0)g.__webglDepthbuffer=n.createRenderbuffer(),R(g.__webglDepthbuffer,E,!1);else{const K=E.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,me=g.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,me),n.framebufferRenderbuffer(n.FRAMEBUFFER,K,n.RENDERBUFFER,me)}}t.bindFramebuffer(n.FRAMEBUFFER,null)}function se(E,g,U){const V=i.get(E);g!==void 0&&De(V.__webglFramebuffer,E,E.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),U!==void 0&&G(E)}function re(E){const g=E.texture,U=i.get(E),V=i.get(g);E.addEventListener("dispose",x);const K=E.textures,me=E.isWebGLCubeRenderTarget===!0,_e=K.length>1;if(_e||(V.__webglTexture===void 0&&(V.__webglTexture=n.createTexture()),V.__version=g.version,a.memory.textures++),me){U.__webglFramebuffer=[];for(let ne=0;ne<6;ne++)if(g.mipmaps&&g.mipmaps.length>0){U.__webglFramebuffer[ne]=[];for(let ce=0;ce<g.mipmaps.length;ce++)U.__webglFramebuffer[ne][ce]=n.createFramebuffer()}else U.__webglFramebuffer[ne]=n.createFramebuffer()}else{if(g.mipmaps&&g.mipmaps.length>0){U.__webglFramebuffer=[];for(let ne=0;ne<g.mipmaps.length;ne++)U.__webglFramebuffer[ne]=n.createFramebuffer()}else U.__webglFramebuffer=n.createFramebuffer();if(_e)for(let ne=0,ce=K.length;ne<ce;ne++){const ge=i.get(K[ne]);ge.__webglTexture===void 0&&(ge.__webglTexture=n.createTexture(),a.memory.textures++)}if(E.samples>0&&Ce(E)===!1){U.__webglMultisampledFramebuffer=n.createFramebuffer(),U.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,U.__webglMultisampledFramebuffer);for(let ne=0;ne<K.length;ne++){const ce=K[ne];U.__webglColorRenderbuffer[ne]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,U.__webglColorRenderbuffer[ne]);const ge=r.convert(ce.format,ce.colorSpace),Ie=r.convert(ce.type),Me=S(ce.internalFormat,ge,Ie,ce.normalized,ce.colorSpace,E.isXRRenderTarget===!0),Se=oe(E);n.renderbufferStorageMultisample(n.RENDERBUFFER,Se,Me,E.width,E.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ne,n.RENDERBUFFER,U.__webglColorRenderbuffer[ne])}n.bindRenderbuffer(n.RENDERBUFFER,null),E.depthBuffer&&(U.__webglDepthRenderbuffer=n.createRenderbuffer(),R(U.__webglDepthRenderbuffer,E,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(me){t.bindTexture(n.TEXTURE_CUBE_MAP,V.__webglTexture),Ge(n.TEXTURE_CUBE_MAP,g);for(let ne=0;ne<6;ne++)if(g.mipmaps&&g.mipmaps.length>0)for(let ce=0;ce<g.mipmaps.length;ce++)De(U.__webglFramebuffer[ne][ce],E,g,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ne,ce);else De(U.__webglFramebuffer[ne],E,g,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ne,0);p(g)&&y(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(_e){for(let ne=0,ce=K.length;ne<ce;ne++){const ge=K[ne],Ie=i.get(ge);let Me=n.TEXTURE_2D;(E.isWebGL3DRenderTarget||E.isWebGLArrayRenderTarget)&&(Me=E.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(Me,Ie.__webglTexture),Ge(Me,ge),De(U.__webglFramebuffer,E,ge,n.COLOR_ATTACHMENT0+ne,Me,0),p(ge)&&y(Me)}t.unbindTexture()}else{let ne=n.TEXTURE_2D;if((E.isWebGL3DRenderTarget||E.isWebGLArrayRenderTarget)&&(ne=E.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(ne,V.__webglTexture),Ge(ne,g),g.mipmaps&&g.mipmaps.length>0)for(let ce=0;ce<g.mipmaps.length;ce++)De(U.__webglFramebuffer[ce],E,g,n.COLOR_ATTACHMENT0,ne,ce);else De(U.__webglFramebuffer,E,g,n.COLOR_ATTACHMENT0,ne,0);p(g)&&y(ne),t.unbindTexture()}E.depthBuffer&&G(E)}function j(E){const g=E.textures;for(let U=0,V=g.length;U<V;U++){const K=g[U];if(p(K)){const me=P(E),_e=i.get(K).__webglTexture;t.bindTexture(me,_e),y(me),t.unbindTexture()}}}const fe=[],he=[];function pe(E){if(E.samples>0){if(Ce(E)===!1){const g=E.textures,U=E.width,V=E.height;let K=n.COLOR_BUFFER_BIT;const me=E.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,_e=i.get(E),ne=g.length>1;if(ne)for(let ge=0;ge<g.length;ge++)t.bindFramebuffer(n.FRAMEBUFFER,_e.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ge,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,_e.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+ge,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,_e.__webglMultisampledFramebuffer);const ce=E.texture.mipmaps;ce&&ce.length>0?t.bindFramebuffer(n.DRAW_FRAMEBUFFER,_e.__webglFramebuffer[0]):t.bindFramebuffer(n.DRAW_FRAMEBUFFER,_e.__webglFramebuffer);for(let ge=0;ge<g.length;ge++){if(E.resolveDepthBuffer&&(E.depthBuffer&&(K|=n.DEPTH_BUFFER_BIT),E.stencilBuffer&&E.resolveStencilBuffer&&(K|=n.STENCIL_BUFFER_BIT)),ne){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,_e.__webglColorRenderbuffer[ge]);const Ie=i.get(g[ge]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,Ie,0)}n.blitFramebuffer(0,0,U,V,0,0,U,V,K,n.NEAREST),l===!0&&(fe.length=0,he.length=0,fe.push(n.COLOR_ATTACHMENT0+ge),E.depthBuffer&&E.storeMultisampledDepthBuffer===!1&&(fe.push(me),he.push(me),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,he)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,fe))}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),ne)for(let ge=0;ge<g.length;ge++){t.bindFramebuffer(n.FRAMEBUFFER,_e.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ge,n.RENDERBUFFER,_e.__webglColorRenderbuffer[ge]);const Ie=i.get(g[ge]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,_e.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+ge,n.TEXTURE_2D,Ie,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,_e.__webglMultisampledFramebuffer)}else if(E.depthBuffer&&E.storeMultisampledDepthBuffer===!1&&l){const g=E.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[g])}}}function oe(E){return Math.min(s.maxSamples,E.samples)}function Ce(E){const g=i.get(E);return E.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&g.__useRenderToTexture!==!1}function C(E){const g=a.render.frame;u.get(E)!==g&&(u.set(E,g),E.update())}function Le(E,g){const U=E.colorSpace,V=E.format,K=E.type;return E.isCompressedTexture===!0||E.isVideoTexture===!0||U!==Da&&U!==Ii&&(st.getTransfer(U)===ht?(V!==Tn||K!==_n)&&Ke("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):lt("WebGLTextures: Unsupported texture color space:",U)),g}function Ee(E){return typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement?(c.width=E.naturalWidth||E.width,c.height=E.naturalHeight||E.height):typeof VideoFrame<"u"&&E instanceof VideoFrame?(c.width=E.displayWidth,c.height=E.displayHeight):(c.width=E.width,c.height=E.height),c}this.allocateTextureUnit=te,this.resetTextureUnits=q,this.getTextureUnits=H,this.setTextureUnits=W,this.setTexture2D=ie,this.setTexture2DArray=Z,this.setTexture3D=J,this.setTextureCube=le,this.rebindTextures=se,this.setupRenderTarget=re,this.updateRenderTargetMipmap=j,this.updateMultisampleRenderTarget=pe,this.setupDepthRenderbuffer=G,this.setupFrameBufferTexture=De,this.useMultisampledRTT=Ce,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function NM(n,e){function t(i,s=Ii){let r;const a=st.getTransfer(s);if(i===_n)return n.UNSIGNED_BYTE;if(i===yc)return n.UNSIGNED_SHORT_4_4_4_4;if(i===Ec)return n.UNSIGNED_SHORT_5_5_5_1;if(i===uh)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===dh)return n.UNSIGNED_INT_10F_11F_11F_REV;if(i===lh)return n.BYTE;if(i===ch)return n.SHORT;if(i===Mr)return n.UNSIGNED_SHORT;if(i===bc)return n.INT;if(i===Yn)return n.UNSIGNED_INT;if(i===Vn)return n.FLOAT;if(i===qn)return n.HALF_FLOAT;if(i===fh)return n.ALPHA;if(i===hh)return n.RGB;if(i===Tn)return n.RGBA;if(i===xi)return n.DEPTH_COMPONENT;if(i===Zi)return n.DEPTH_STENCIL;if(i===ph)return n.RED;if(i===Tc)return n.RED_INTEGER;if(i===ts)return n.RG;if(i===Ac)return n.RG_INTEGER;if(i===wc)return n.RGBA_INTEGER;if(i===ga||i===_a||i===va||i===xa)if(a===ht)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(i===ga)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===_a)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===va)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===xa)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(i===ga)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===_a)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===va)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===xa)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===bl||i===yl||i===El||i===Tl)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(i===bl)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===yl)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===El)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Tl)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Al||i===wl||i===Rl||i===Cl||i===Pl||i===Ca||i===Dl)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(i===Al||i===wl)return a===ht?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(i===Rl)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(i===Cl)return r.COMPRESSED_R11_EAC;if(i===Pl)return r.COMPRESSED_SIGNED_R11_EAC;if(i===Ca)return r.COMPRESSED_RG11_EAC;if(i===Dl)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===Ll||i===Il||i===Ul||i===Nl||i===Fl||i===Ol||i===Bl||i===Hl||i===kl||i===Vl||i===zl||i===Gl||i===Wl||i===Xl)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(i===Ll)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Il)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Ul)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Nl)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Fl)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Ol)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Bl)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Hl)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===kl)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Vl)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===zl)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Gl)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Wl)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Xl)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Yl||i===ql||i===Kl)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(i===Yl)return a===ht?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===ql)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===Kl)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===Zl||i===$l||i===Pa||i===Jl)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(i===Zl)return r.COMPRESSED_RED_RGTC1_EXT;if(i===$l)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Pa)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===Jl)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===br?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:t}}const FM=`
void main() {
