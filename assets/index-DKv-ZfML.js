...
`)),a=[],o=561},c=ue=>{o-ue<34&&l()},u=(ue,Oe,We,K,se)=>{a.push(`${se.join(" ")} rg ${ue} ${Oe} ${We} ${K} re f`)},f=(ue,Oe,We,K=9,se="F1",ve=[.11,.17,.23])=>{a.push(`${ve.join(" ")} rg BT /${se} ${K} Tf ${Oe} ${We} Td (${gb(ue)}) Tj ET`)},d=(ue,Oe,We,K)=>{a.push(`0.72 w 0.70 0.77 0.86 RG ${ue} ${Oe} m ${We} ${K} l S`)},h=(ue,Oe=34,We=9,K="F1",se=13,ve)=>{c(se),f(ue,Oe,o,We,K,ve),o-=se},v=(ue,Oe,We,K,se=9)=>{kd(`${ue}: ${Oe||"--"}`,K).forEach(ze=>h(ze,We,se))},b=Array.isArray(n.rows)?n.rows:[],m=b.filter(ue=>this.getStatus(ue)==="CRITICO").length,p=b.filter(ue=>this.getStatus(ue)==="ALERTA").length,y=b.filter(ue=>this.getStatus(ue)==="OK").length,P=b.reduce((ue,Oe)=>ue+this.rowAssignedHours(Oe),0),S=b.reduce((ue,Oe)=>ue+this.rowConsumedHours(Oe),0),T=b.reduce((ue,Oe)=>ue+this.rowRemainingHours(Oe),0),A=b.map(ue=>({row:ue,dueDate:Ci(ue.due)})).filter(ue=>ue.dueDate).sort((ue,Oe)=>ue.dueDate-Oe.dueDate)[0],D=m>0?"CRITICO":p>0?"ALERTA":b.length?"OPERATIVO":"SIN DATOS";u(34,o-7,774,30,[.04,.23,.47]),f("DIVMAAER - Control de Calidad",46,o+3,12,"F2",[1,1,1]),o-=40,u(34,o-8,774,27,[.86,.92,1]),f(`Reporte de Aeronave: ${n.code}`,46,o+2,13,"F2",[.04,.23,.47]),o-=34,h(n.name||"--",34,11,"F1",16,[.25,.31,.38]),d(34,o+3,808,o+3),o-=12,h("Resumen operativo",34,13,"F2",18,[.04,.23,.47]),h(`Fecha de reporte: ${Li(new Date)}`,34,9,"F1",13);const x=D==="CRITICO"?[.61,.11,.11]:D==="ALERTA"?[.48,.32,0]:[.08,.42,.23];h(`Estado general: ${D}`,34,9,"F2",13,x),h(`Componentes registrados: ${b.length} | Operativos: ${y} | Alertas: ${p} | Criticos: ${m}`,34,9,"F1",13),h(`TBO asignado: ${this.formatMetric(P)} h | Consumido: ${this.formatMetric(S)} h | Remanente: ${this.formatMetric(T)} h`,34,9,"F1",13),h(`Proximo vencimiento: ${A?`${A.row.component||"Componente"} (${A.row.due})`:"--"}`,34,9,"F1",16),v("Notas",n.notes,34,110,9),o-=6,h("Componentes",34,13,"F2",18,[.04,.23,.47]),b.length===0&&h("No hay componentes registrados para esta aeronave.",34,9,"F1",13);const w=14.2,L=[{x:46,width:240},{x:300,width:240},{x:554,width:220}],F=12,G=ue=>[["Componente",ue.component||"--"],["Serie",ue.series||"--"],["Fecha fabricacion",ue.manufactureDate||"--"],["Taller",ue.workshop||"--"],["Ultimo Overhaul",ue.overhaul||"--"],["Vencimiento",ue.due||"--"],["Asignado TBO hrs",ue.assignedTboHours||ue.assigned||"--"],["Asignado TBO anos",ue.assignedTboYears||"--"],["Consumido TBO hrs",ue.consumedTboHours||ue.consumed||"--"],["Consumido TBO anos",ue.consumedTboYears||"--"],["Remanente TBO hrs",ue.remainingTboHours||ue.remaining||"--"],["Remanente TBO anos",ue.remainingTboYears||"--"],["Asignado TSN hrs",ue.assignedTsnHours||"--"],["Asignado TSN anos",ue.assignedTsnYears||"--"],["Consumido TSN hrs",ue.consumedTsnHours||"--"],["Consumido TSN anos",ue.consumedTsnYears||"--"],["Remanente TSN hrs",ue.remainingTsnHours||"--"],["Remanente TSN anos",ue.remainingTsnYears||"--"],["Arranques TSN de motores",ue.motorStartsTsn||"--"],["Gaso-horas TSN",ue.gasHoursTsn||"--"],["Arranque TBO de motores",ue.motorStartsTbo||"--"],["Gaso-horas TBO",ue.gasHoursTbo||"--"],["Estado",this.getStatus(ue)],["Notas",ue.notes||"--"]];b.forEach((ue,Oe)=>{const We=G(ue),K=Math.ceil(We.length/L.length),se=41+K*F+w;c(se);const ve=this.getStatus(ue),ze=ve==="CRITICO"?[.61,.11,.11]:ve==="ALERTA"?[.8,.53,0]:[.08,.42,.23],Pe=ve==="CRITICO"?[1,.92,.92]:ve==="ALERTA"?[1,.97,.84]:[.95,.98,1],R=o;u(34,R-9,774,22,ze),f(`Componente ${Oe+1}: ${ue.component||"Sin nombre"}`,46,R-1,9.2,"F2",[1,1,1]),f(ve,740,R-1,9.2,"F2",[1,1,1]);const I=R-31,z=K*F+10;u(34,I-z+12,774,z,Pe),d(34,R+13,808,R+13),d(34,I-z+12,808,I-z+12),We.forEach(([ne,ae],Q)=>{const fe=L[Q%L.length],he=Math.floor(Q/L.length),pe=I-he*F,oe=fe.x+86,Re=Math.max(8,Math.floor((fe.width-92)/4.2)),C=ne==="Estado",De=C?ve==="CRITICO"?[.61,.11,.11]:ve==="ALERTA"?[.48,.32,0]:[.08,.42,.23]:[.11,.17,.23];f(`${ne}:`,fe.x,pe,7.4,"F2",[.04,.23,.47]),f(kd(ae,Re)[0],oe,pe,7.4,C?"F2":"F1",De)}),o=I-z+12-w-13}),r.push(a.join(`
`));const q=[],B=ue=>(q.push(ue),q.length),W=B("<< /Type /Font /Subtype /Type1 /BaseFont /Helvetica >>"),ee=B("<< /Type /Font /Subtype /Type1 /BaseFont /Helvetica-Bold >>"),V=[],ie=r.map(ue=>B(`<< /Length ${ue.length} >>
stream
${ue}
endstream`)),J=q.length+r.length+1;ie.forEach(ue=>{const Oe=B(`<< /Type /Page /Parent ${J} 0 R /MediaBox [0 0 842 595] /Resources << /Font << /F1 ${W} 0 R /F2 ${ee} 0 R >> >> /Contents ${ue} 0 R >>`);V.push(Oe)}),B(`<< /Type /Pages /Kids [${V.map(ue=>`${ue} 0 R`).join(" ")}] /Count ${V.length} >>`);const j=B(`<< /Type /Catalog /Pages ${J} 0 R >>`);let re=`%PDF-1.4
`;const Me=[0];q.forEach((ue,Oe)=>{Me.push(re.length),re+=`${Oe+1} 0 obj
${ue}
endobj
...
startxref
${Fe}
%%EOF`,re},pct(n){const e=Math.max(this.metrics.total,1);return`${Math.round(n/e*100)}%`},getStatus(n){const e=this.rowRemainingHours(n),t=Ci(n.due);if(e<0||t&&t<pn)return"CRITICO";const i=this.rowAssignedHours(n),s=t?Math.floor((t-pn)/864e5):null;return s!==null&&s<=180||i>0&&e<=i*.15?"ALERTA":"OK"},statusClass(n){const e=this.getStatus(n);return e==="CRITICO"?"critical":e==="ALERTA"?"warn":"ok"},navigate(n,e=""){var t;this.activeView=n,this.activeMenuLabel=e||((t=this.menuItems.find(i=>i.target===n))==null?void 0:t.label)||"Dashboard",this.setMobileMenuOpen(!1),this.$nextTick(()=>{const i=document.getElementById(n);i&&this.highlightAndScroll(i)})},highlightAndScroll(n){n.scrollIntoView({behavior:"smooth",block:"start"}),n.classList.add("jump-highlight"),window.setTimeout(()=>n.classList.remove("jump-highlight"),1200)},async openAircraft(n){n&&(this.fleet.selectedId=n,await this.persistFleet(),this.navigate("dashboard"))},startAircraftEdit(n){if(!this.isOwner){window.alert("Solo el propietario puede editar aeronaves.");return}this.editingAircraftId=n.id,this.editingAircraftDraft={code:n.code,name:n.name,notes:n.notes||""}},cancelAircraftEdit(){this.editingAircraftId="",this.editingAircraftDraft={code:"",name:"",notes:""}},async saveAircraftEdit(n){if(!this.isOwner){window.alert("Solo el propietario puede editar aeronaves.");return}const e=this.fleet.aircrafts.find(o=>o.id===n),t=this.editingAircraftDraft.code.trim().toUpperCase(),i=this.editingAircraftDraft.name.trim(),s=this.editingAircraftDraft.notes.trim();if(!e||!t||!i){window.alert("Ingresa codigo y nombre para guardar la aeronave.");return}if(this.fleet.aircrafts.some(o=>o.id!==n&&o.code.toUpperCase()===t)){window.alert("Ese codigo ya existe.");return}e.code=t,e.name=i,e.notes=s,this.cancelAircraftEdit(),this.recordSystemChange("Aeronave actualizada",`${t} - ${i}`,t),await this.persistFleet()||window.alert("La aeronave se actualizo localmente, pero Firebase no pudo sincronizar el cambio.")},aircraftIndex(n){return this.fleet.aircrafts.findIndex(e=>e.id===n)},startAircraftDrag(n,e){if(!this.isOwner||this.editingAircraftId===e){n.preventDefault();return}this.draggingAircraftId=e,n.dataTransfer.effectAllowed="move",n.dataTransfer.setData("text/plain",e)},async dropAircraft(n,e){if(!this.isOwner)return;const t=n.dataTransfer.getData("text/plain")||this.draggingAircraftId,i=this.aircraftIndex(t),s=this.aircraftIndex(e);if(i<0||s<0||i===s){this.finishAircraftDrag();return}const r=[...this.fleet.aircrafts],[a]=r.splice(i,1);r.splice(s,0,a),this.fleet.aircrafts=r,this.finishAircraftDrag(),this.recordSystemChange("Aeronaves reordenadas",`${a.code} movida en la lista`,a.code),await this.persistFleet()||window.alert("El orden se actualizo localmente, pero Firebase no pudo sincronizar el cambio.")},finishAircraftDrag(){this.draggingAircraftId=""},async createAircraft(){if(!this.isOwner){window.alert("Solo el propietario puede crear aeronaves.");return}const n=this.newAircraft.code.trim().toUpperCase(),e=this.newAircraft.name.trim(),t=this.newAircraft.notes.trim();if(!n||!e){window.alert("Ingresa codigo y nombre para crear la aeronave.");return}if(this.fleet.aircrafts.some(l=>l.code.toUpperCase()===n)){window.alert("Ese codigo ya existe.");return}const s=`${n.toLowerCase().replace(/[^a-z0-9]+/g,"-")}-${Date.now()}`,r=window.scrollX,a=window.scrollY;this.fleet.aircrafts.push({id:s,code:n,name:e,notes:t,rows:[]}),this.fleet.selectedId=s,this.newAircraft.code="",this.newAircraft.name="",this.newAircraft.notes="",this.recordSystemChange("Aeronave creada",`${n} - ${e}`,n);const o=await this.persistFleet();this.$nextTick(()=>window.scrollTo(r,a)),o||window.alert("La aeronave se creo localmente, pero Firebase no la pudo sincronizar. Revisa reglas y login.")},canDeleteAircraft(n){return this.isOwner&&!!n},async deleteAircraft(n){if(!this.isOwner){window.alert("Solo el propietario puede eliminar aeronaves.");return}const e=this.fleet.aircrafts.find(s=>s.id===n);if(!this.canDeleteAircraft(e)){window.alert("No se puede eliminar esta aeronave.");return}if(!window.confirm(`Deseas eliminar la aeronave ${e.code}?`))return;this.addToTrash("aircraft",e,e,`${e.code} - ${e.name}`),this.fleet.aircrafts=this.fleet.aircrafts.filter(s=>s.id!==n),this.fleet.selectedId===n&&(this.fleet.selectedId=this.fleet.aircrafts[0]?this.fleet.aircrafts[0].id:""),this.recordSystemChange("Aeronave eliminada",`${e.code} - ${e.name}`,e.code),await this.persistFleet()||window.alert("La aeronave se elimino localmente, pero Firebase no pudo sincronizar el cambio.")},getComponentTemplate(n="generic"){const e={component:"Nuevo componente",series:"",manufactureDate:"",workshop:"",overhaul:Li(pn),assigned:"0",consumed:"0",remaining:"0",assignedTboHours:"0",assignedTboYears:"1",consumedTboHours:"0",consumedTboYears:sr(),assignedTsnHours:"0",assignedTsnYears:"1",consumedTsnHours:"0",consumedTsnYears:sr(),remainingTboHours:"0",remainingTboYears:"0",remainingTsnHours:"0",remainingTsnYears:Es(Li(pn),"1"),motorStartsTsn:"",gasHoursTsn:"",motorStartsTbo:"",gasHoursTbo:"",notes:"",due:Es(Li(pn),"1")};return n==="apu-tg-16m"?{...e,component:"APU TG-16M",assignedTboYears:"",assignedTsnYears:"",remainingTsnYears:"",due:""}:e},async addRow(n="generic"){if(!this.isOwner){window.alert("Solo el propietario puede editar.");return}if(!this.currentAircraft)return;this.componentAddMenuOpen=!1;const e=qi(this.getComponentTemplate(n));this.currentAircraft.rows.push(e),this.recordSystemChange("Componente agregado",`${this.currentAircraft.code}: ${e.component||"Nuevo componente"}`),await this.persistFleet()},startRowDrag(n,e){if(!this.isOwner){n.preventDefault();return}this.draggingRowIndex=e,n.dataTransfer.effectAllowed="move",n.dataTransfer.setData("text/plain",String(e))},async dropRow(n){if(!this.isOwner||!this.currentAircraft||!Array.isArray(this.currentAircraft.rows)){this.finishRowDrag();return}if(this.draggingRowIndex===null)return;const e=Number(this.draggingRowIndex);if(!Number.isInteger(e)||e<0||n<0||n>=this.currentAircraft.rows.length||e===n){this.finishRowDrag();return}const t=[...this.currentAircraft.rows],[i]=t.splice(e,1);t.splice(n,0,i),this.currentAircraft.rows=t,this.finishRowDrag(),this.recordSystemChange("Componentes reordenados",`${i.component||"Sin nombre"} movido en ${this.currentAircraft.code}`),await this.persistFleet()||window.alert("El orden se actualizo localmente, pero Firebase no pudo sincronizar el cambio.")},finishRowDrag(){this.draggingRowIndex=null},async resetDb(){if(!this.isOwner){window.alert("Solo el propietario puede editar.");return}!window.confirm("Deseas restaurar la base de datos original?")||!this.currentAircraft||(this.currentAircraft.rows=this.currentAircraft.id==="pnp-501"?hr(Vh).map(qi):[],this.recordSystemChange("Base de datos restaurada",`${this.currentAircraft.code}: datos restaurados`),await this.persistFleet())},async deleteRow(n){if(!this.isOwner){window.alert("Solo el propietario puede editar.");return}if(!this.currentAircraft||!Array.isArray(this.currentAircraft.rows)||n<0||n>=this.currentAircraft.rows.length)return;const e=this.currentAircraft.rows[n],t=e&&e.component?e.component:"este componente";window.confirm(`Deseas eliminar ${t}?`)&&(this.addToTrash("component",e,this.currentAircraft,t),this.currentAircraft.rows.splice(n,1),this.recordSystemChange("Componente eliminado",`${this.currentAircraft.code}: ${t}`),await this.persistFleet())},async restoreTrashItem(n){if(!this.isOwner){window.alert("Solo el propietario puede restaurar elementos.");return}const e=bs(this.fleet.trash),t=e.find(s=>s.id===n);if(!t){window.alert("Este elemento ya no esta disponible en la papelera."),this.fleet.trash=e,await this.persistFleet();return}if(t.type==="aircraft"){const s={...t.data,id:t.data.id||`${Qs(t.aircraftCode||t.name)}-${Date.now()}`,rows:Array.isArray(t.data.rows)?t.data.rows.map(qi):[]},r=this.fleet.aircrafts.some(a=>a.id===s.id);s.id=r?`${s.id}-${Date.now()}`:s.id,this.fleet.aircrafts.push(s),this.fleet.selectedId=s.id,this.recordSystemChange("Aeronave restaurada",`${s.code} - ${s.name}`,s.code)}else{const s=this.fleet.aircrafts.find(r=>r.id===t.aircraftId)||this.fleet.aircrafts.find(r=>r.code===t.aircraftCode)||this.currentAircraft;if(!s){window.alert("No hay aeronave disponible para restaurar el componente.");return}s.rows.push(qi(t.data)),this.fleet.selectedId=s.id,this.recordSystemChange("Componente restaurado",`${s.code}: ${t.name}`)}this.fleet.trash=e.filter(s=>s.id!==n),await this.persistFleet()||window.alert("El elemento se restauro localmente, pero Firebase no pudo sincronizar el cambio.")},setMobileMenuOpen(n){this.mobileMenuOpen=n},handleResize(){window.innerWidth>760&&this.setMobileMenuOpen(!1)},getAuthErrorMessage(n){const e=n&&n.code?n.code:"";return e==="auth/invalid-credential"||e==="auth/wrong-password"||e==="auth/user-not-found"?"Correo o contrasena incorrectos.":e==="auth/too-many-requests"?"Demasiados intentos. Espera un momento y vuelve a probar.":e==="auth/operation-not-allowed"?"Activa Email/Password en Firebase Authentication.":e==="auth/weak-password"?"La contrasena debe tener al menos 6 caracteres.":e==="auth/email-already-in-use"?"Ese correo ya existe. Usa Ingresar o restablece la contrasena.":e==="auth/invalid-email"?"Ingresa un correo valido.":"No se pudo iniciar sesion con correo."},async createEmailUser(){if(!this.authReady)return this.updateLoginHint("Firebase Auth no esta disponible.",!0),!1;if(!this.loginEmail||!this.loginPassword)return this.updateLoginHint("Ingresa correo y contrasena para crear la cuenta.",!0),!1;try{return this.authBusy=!0,await window.firebase.auth().createUserWithEmailAndPassword(this.loginEmail,this.loginPassword),this.loginPassword="",this.updateLoginHint("Cuenta creada e ingreso correcto."),!0}catch(n){return console.error("Email sign-up error:",n),this.updateLoginHint(this.getAuthErrorMessage(n),!0),!1}finally{this.authBusy=!1}},async sendPasswordReset(){if(!this.authReady){this.updateLoginHint("Firebase Auth no esta disponible.",!0);return}if(!this.loginEmail){this.updateLoginHint("Escribe tu correo para enviar el restablecimiento.",!0);return}try{this.authBusy=!0,await window.firebase.auth().sendPasswordResetEmail(this.loginEmail),this.updateLoginHint("Te enviamos un correo para restablecer la contrasena.")}catch(n){console.error("Password reset error:",n),this.updateLoginHint(this.getAuthErrorMessage(n),!0)}finally{this.authBusy=!1}},async signInWithEmail(){if(!this.authReady){this.updateLoginHint("Firebase Auth no esta disponible.",!0);return}if(!this.loginEmail||!this.loginPassword){this.updateLoginHint("Ingresa correo y contrasena.",!0);return}try{this.authBusy=!0,await window.firebase.auth().signInWithEmailAndPassword(this.loginEmail,this.loginPassword),this.loginPassword="",this.updateLoginHint("Ingreso correcto con correo.")}catch(n){console.error("Email sign-in error:",n),this.updateLoginHint(this.getAuthErrorMessage(n),!0)}finally{this.authBusy=!1}},async signOut(){if(!this.authReady){this.currentUser=null,this.isOwner=!1;return}await window.firebase.auth().signOut()},async initAuth(){if(!_b()){this.updateLoginHint("Configura Firebase Auth para iniciar sesion.",!0);return}try{await tl("https://www.gstatic.com/firebasejs/10.12.3/firebase-app-compat.js"),await tl("https://www.gstatic.com/firebasejs/10.12.3/firebase-auth-compat.js"),await tl("https://www.gstatic.com/firebasejs/10.12.3/firebase-firestore-compat.js")}catch(n){console.error("Firebase SDK load error:",n),this.updateLoginHint("Firebase Auth no esta disponible.",!0),this.updateCloudStatus("Sin conexion",!0,this.getFirebaseErrorMessage(n));return}if(!window.firebase||!window.firebase.firestore){this.updateLoginHint("Firebase Auth no esta disponible.",!0),this.updateCloudStatus("Sin Firebase",!0);return}window.firebase.apps.length||window.firebase.initializeApp(kh),this.authReady=!0,this.dbReady=!0,window.firebase.auth().onAuthStateChanged(async n=>{if(this.currentUser=n,this.isOwner=!1,!n||n.isAnonymous){this.firestoreUnsubscribe&&(this.firestoreUnsubscribe(),this.firestoreUnsubscribe=null),this.updateCloudStatus("Requiere login"),this.updateLoginHint("Usa Ingresar si ya tienes cuenta, o Crear cuenta si es tu primera vez.");return}const e=(n.email||"").toLowerCase();let t="";try{t=(await n.getIdTokenResult()).claims.role||""}catch(i){console.warn("No se pudieron leer los claims de Auth:",i)}this.isOwner=t==="editor"||vb(e),n&&!this.isOwner&&this.updateLoginHint("Ingreso autenticado en modo solo lectura."),n&&this.isOwner&&this.updateLoginHint("Ingreso autenticado en modo editor."),await this.loadFleetFromFirestore(),this.subscribeFleetFromFirestore()})}}},Sb={key:0,class:"login-screen"},Mb={id:"three-bg",ref:"threeBg","aria-hidden":"true"},bb=["disabled"],yb={class:"password-field"},Eb=["type","disabled"],Tb=["disabled"],Ab=["src"],wb={class:"login-actions"},Rb=["disabled"],Cb=["src"],Pb=["disabled"],Db=["src"],Lb=["disabled"],Ib={key:1,class:"layout"},Ub={class:"brand"},Nb={class:"brand-sub"},Fb=["aria-label","title"],Ob=["src"],Bb={id:"sidebar-menu",class:"menu"},Hb=["href","onClick"],kb={class:"menu-icon","aria-hidden":"true"},Vb=["src"],zb={class:"menu-label"},Gb={class:"content"},Wb={class:"topbar"},Xb={class:"topbar-left"},Yb=["src"],qb={class:"title-wrap"},Kb={class:"top-actions"},Zb=["title"],$b={class:"chip aircraft-chip"},Jb={class:"chip date-chip"},Qb=["src"],jb=["title"],ey=["src"],ty=["title"],ny=["title"],iy={class:"auth-status"},sy=["src"],ry=["src"],ay={id:"aeronaves",class:"view"},oy={class:"panel"},ly={class:"aircrafts-layout"},cy={class:"aircraft-list"},uy=["draggable","onDragstart","onDrop"],dy={key:0,class:"aircraft-notes"},fy={class:"aircraft-actions"},hy=["disabled","onClick"],py=["src"],my=["onClick"],gy=["src"],_y=["disabled","onClick"],vy=["src"],xy=["aria-label","title","onClick"],Sy=["src"],My=["onClick"],by=["src"],yy={key:0,class:"empty-note"},Ey=["disabled"],Ty=["disabled"],Ay=["disabled"],wy=["disabled"],Ry=["src"],Cy={key:0,id:"dashboard",ref:"dashboard",class:"grid-kpi view"},Py={class:"kpi kpi-info"},Dy={class:"kpi-head"},Ly={class:"kpi-icon","aria-hidden":"true"},Iy=["src"],Uy={class:"kpi-value"},Ny={class:"kpi kpi-danger"},Fy={class:"kpi-head"},Oy={class:"kpi-icon","aria-hidden":"true"},By=["src"],Hy={class:"kpi-value"},ky={class:"kpi-meta"},Vy={class:"kpi-progress"},zy={class:"kpi kpi-warn"},Gy={class:"kpi-head"},Wy={class:"kpi-icon","aria-hidden":"true"},Xy=["src"],Yy={class:"kpi-value"},qy={class:"kpi-meta"},Ky={class:"kpi-progress"},Zy={class:"kpi kpi-ok"},$y={class:"kpi-head"},Jy={class:"kpi-icon","aria-hidden":"true"},Qy=["src"],jy={class:"kpi-value"},eE={class:"kpi-meta"},tE={class:"kpi-progress"},nE={class:"kpi risk-card"},iE={class:"kpi-risk"},sE={class:"risk-copy"},rE={key:1,id:"main-grid-view",class:"main-grid view"},aE={class:"panel"},oE={class:"panel-sub"},lE={class:"plane-title"},cE={class:"meta-list"},uE={class:"state-pill"},dE={class:"progress-title"},fE={class:"progress"},hE={class:"panel"},pE={class:"resource-chart"},mE={class:"resource-row-head"},gE={class:"resource-name"},_E=["aria-label"],vE={class:"resource-values"},xE={class:"panel"},SE={class:"icon-heading"},ME=["src"],bE={class:"events"},yE={key:2,id:"componentes",class:"analytics-grid view"},EE={class:"panel analytics-panel"},TE={class:"donut-layout"},AE={class:"donut-center"},wE={class:"chart-list"},RE={class:"panel analytics-panel trend-panel"},CE={class:"trend-chart"},PE={class:"trend-axis-label top"},DE={viewBox:"0 0 600 180",role:"img","aria-label":"Tendencia de consumo y remanente"},LE=["y1","y2"],IE=["points"],UE=["points"],NE=["cx","cy"],FE=["cx","cy"],OE=["x"],BE={class:"panel analytics-panel"},HE={class:"donut-layout status-layout"},kE={class:"donut-center"},VE={class:"chart-list"},zE={key:3,id:"base-datos",ref:"baseDatos",class:"panel table-panel view"},GE={class:"table-title"},WE={class:"table-tools"},XE={class:"component-add-menu"},YE=["disabled"],qE=["src"],KE={key:0,class:"component-add-options"},ZE=["disabled"],$E=["src"],JE={class:"table-wrap"},QE=["onDrop"],jE={class:"row-drag-cell"},eT=["disabled","onDragstart"],tT={class:"table-component"},nT=["onUpdate:modelValue","disabled","onChange"],iT=["onUpdate:modelValue","disabled","onChange"],sT=["onUpdate:modelValue","disabled","onChange"],rT=["onUpdate:modelValue","disabled","onChange"],aT=["onUpdate:modelValue","disabled","onInput","onChange"],oT=["onUpdate:modelValue","disabled","onInput","onChange"],lT=["onUpdate:modelValue","disabled","onInput","onChange"],cT=["onUpdate:modelValue","disabled","onInput","onChange"],uT=["onUpdate:modelValue"],dT=["onUpdate:modelValue","disabled","onInput","onChange"],fT=["onUpdate:modelValue","disabled","onInput","onChange"],hT=["onUpdate:modelValue","disabled","onInput","onChange"],pT=["onUpdate:modelValue"],mT=["onUpdate:modelValue"],gT=["onUpdate:modelValue"],_T=["onUpdate:modelValue"],vT=["onUpdate:modelValue"],xT=["onUpdate:modelValue","disabled","onChange"],ST=["onUpdate:modelValue","disabled","onChange"],MT=["onUpdate:modelValue","disabled","onChange"],bT=["onUpdate:modelValue","disabled","onChange"],yT=["onUpdate:modelValue","disabled","onChange"],ET=["onUpdate:modelValue"],TT=["disabled","onClick"],AT=["src"],wT={key:4,id:"alertas",class:"view"},RT={class:"stats-row"},CT={class:"mini"},PT={style:{color:"var(--danger)"}},DT={class:"mini"},LT={style:{color:"var(--warn)"}},IT={class:"mini"},UT={style:{color:"var(--warn)"}},NT={class:"mini"},FT={style:{color:"#ffd58f"}},OT={class:"mini"},BT={class:"panel"},HT={class:"events"},kT={class:"event-aircraft"},VT={key:5,id:"calendario",class:"panel view"},zT={class:"icon-heading"},GT=["src"],WT={class:"events"},XT={key:6,id:"historial",class:"panel table-panel view"},YT={class:"change-log"},qT={key:0,class:"change-aircraft"},KT={key:0,class:"empty-note"},ZT={class:"table-wrap"},$T={class:"history-table"},JT={key:7,id:"papelera",class:"panel table-panel view"},QT={class:"table-wrap"},jT={class:"trash-table"},eA=["disabled","onClick"],tA=["src"],nA={key:0};function iA(n,e,t,i,s,r){return Ye(),qe("div",{class:Dt(["app-shell",{"sidebar-collapsed":s.sidebarCollapsed,"text-large":s.textSizeLarge}])},[r.isAuthenticated?(Ye(),qe("div",Ib,[_("aside",{class:Dt(["sidebar",{open:s.mobileMenuOpen}])},[_("div",Ub,[e[40]||(e[40]=_("h2",{class:"brand-title"},"DIVMAAER",-1)),_("p",Nb,xe(r.currentAircraft?r.currentAircraft.code:"CONTROL DE CALIDAD"),1)]),_("button",{class:"sidebar-collapse-btn",type:"button","aria-label":s.sidebarCollapsed?"Desplegar menu lateral":"Ocultar menu lateral",title:s.sidebarCollapsed?"Desplegar menu":"Ocultar menu",onClick:e[15]||(e[15]=a=>s.sidebarCollapsed=!s.sidebarCollapsed)},[_("img",{class:"btn-icon",src:s.sidebarCollapsed?s.icons.expand:s.icons.collapse,alt:"","aria-hidden":"true"},null,8,Ob)],8,Fb),_("nav",Bb,[(Ye(!0),qe(_t,null,nn(s.menuItems,a=>(Ye(),qe("a",{key:a.label,class:Dt(["menu-item",{active:s.activeMenuLabel===a.label}]),href:`#${a.target}`,onClick:Sn(o=>r.navigate(a.target,a.label),["prevent"])},[_("span",kb,[_("img",{src:a.icon,alt:""},null,8,Vb)]),_("span",zb,xe(a.label),1)],10,Hb))),128))]),e[41]||(e[41]=_("div",{class:"profile"},[_("b",null,"Marlon Chuquino"),ot(" Administrador ")],-1))],2),_("div",{class:Dt(["mobile-menu-backdrop",{open:s.mobileMenuOpen}]),onClick:e[16]||(e[16]=a=>r.setMobileMenuOpen(!1))},null,2),_("main",Gb,[_("header",Wb,[_("div",Xb,[_("button",{class:"mobile-menu-btn",type:"button","aria-label":"Abrir menu",onClick:e[17]||(e[17]=a=>r.setMobileMenuOpen(!s.mobileMenuOpen))},[_("img",{class:"btn-icon",src:s.icons.menu,alt:"","aria-hidden":"true"},null,8,Yb)]),e[42]||(e[42]=_("div",{class:"topbar-brand"},[_("p",{class:"topbar-kicker"},"CONTROL DE CALIDAD"),_("h1",null,"Sistema de Gestión de Recursos Aeronáuticos")],-1))]),_("div",qb,[_("p",null,"Dashboard tecnico · "+xe(r.currentAircraft?r.currentAircraft.code:"--"),1)]),_("div",Kb,[_("button",{class:"chip text-size-btn",type:"button",title:s.textSizeLarge?"Achicar letras":"Agrandar letras",onClick:e[18]||(e[18]=a=>s.textSizeLarge=!s.textSizeLarge)},xe(s.textSizeLarge?"A-":"A+"),9,Zb),_("div",$b,[_("span",null,xe(r.aircraftChip),1),e[43]||(e[43]=ot()),e[44]||(e[44]=_("span",null,"▼",-1))]),_("div",Jb,[_("img",{class:"chip-icon",src:s.icons.calendar,alt:"","aria-hidden":"true"},null,8,Qb),ot(" "+xe(r.todayLabel),1)]),_("div",{class:Dt(["chip firebase-chip",{"sync-error":s.cloudStatusError}]),title:s.cloudErrorMessage||s.cloudStatus},[_("img",{class:"chip-icon",src:s.icons.sync,alt:"","aria-hidden":"true"},null,8,ey),_("span",null,"Firebase "+xe(r.cloudStatusText),1)],10,jb),_("div",{class:"chip sync-info-chip",title:`Fuente: ${r.syncSourceText}`},[_("span",{class:Dt(["sync-source-dot",{remote:s.syncSource==="remote"}])},null,2),_("span",null,"Últ. sync: "+xe(r.lastSyncLabel),1)],8,ty),_("div",{class:"auth-box",title:s.authHint},[_("span",iy,[_("img",{class:"btn-icon",src:s.icons.user,alt:"","aria-hidden":"true"},null,8,sy),ot(xe(r.authStatus),1)]),_("button",{class:"auth-btn",type:"button",onClick:e[19]||(e[19]=(...a)=>r.signOut&&r.signOut(...a))},[_("img",{class:"btn-icon",src:s.icons.signOut,alt:"","aria-hidden":"true"},null,8,ry),e[45]||(e[45]=ot(" Cerrar sesion ",-1))])],8,ny)])]),lt(_("section",ay,[_("section",oy,[e[51]||(e[51]=_("h2",null,"Gestion de Aeronaves",-1)),e[52]||(e[52]=_("p",{class:"panel-sub"},"Selecciona una aeronave operativa o crea una nueva con base de datos vacia.",-1)),_("div",ly,[_("div",null,[_("div",cy,[(Ye(!0),qe(_t,null,nn(s.fleet.aircrafts,a=>(Ye(),qe("article",{key:a.id,class:Dt(["aircraft-card",{active:a.id===s.fleet.selectedId,dragging:s.draggingAircraftId===a.id}]),draggable:s.isOwner&&s.editingAircraftId!==a.id,onDragstart:o=>r.startAircraftDrag(o,a.id),onDragover:e[24]||(e[24]=Sn(()=>{},["prevent"])),onDrop:Sn(o=>r.dropAircraft(o,a.id),["prevent"]),onDragend:e[25]||(e[25]=(...o)=>r.finishAircraftDrag&&r.finishAircraftDrag(...o))},[s.editingAircraftId===a.id?(Ye(),qe(_t,{key:0},[lt(_("input",{"onUpdate:modelValue":e[20]||(e[20]=o=>s.editingAircraftDraft.code=o),class:"aircraft-edit-input",type:"text",maxlength:"30","aria-label":"Codigo de aeronave"},null,512),[[ct,s.editingAircraftDraft.code,void 0,{trim:!0}]]),lt(_("input",{"onUpdate:modelValue":e[21]||(e[21]=o=>s.editingAircraftDraft.name=o),class:"aircraft-edit-input",type:"text",maxlength:"80","aria-label":"Nombre de aeronave"},null,512),[[ct,s.editingAircraftDraft.name,void 0,{trim:!0}]]),lt(_("textarea",{"onUpdate:modelValue":e[22]||(e[22]=o=>s.editingAircraftDraft.notes=o),class:"aircraft-edit-input aircraft-notes-input",maxlength:"240","aria-label":"Notas de aeronave",placeholder:"Notas"},null,512),[[ct,s.editingAircraftDraft.notes,void 0,{trim:!0}]]),_("p",null,"Componentes: "+xe(a.rows.length),1)],64)):(Ye(),qe(_t,{key:1},[_("h3",null,xe(a.code),1),_("p",null,xe(a.name),1),a.notes?(Ye(),qe("p",dy,xe(a.notes),1)):Vt("",!0),_("p",null,"Componentes: "+xe(a.rows.length),1)],64)),_("div",fy,[s.editingAircraftId===a.id?(Ye(),qe(_t,{key:0},[_("button",{class:"table-btn",type:"button",disabled:!s.isOwner,onClick:o=>r.saveAircraftEdit(a.id)},[_("img",{class:"btn-icon",src:s.icons.save,alt:"","aria-hidden":"true"},null,8,py),e[46]||(e[46]=ot("Guardar",-1))],8,hy),_("button",{class:"table-btn",type:"button",onClick:e[23]||(e[23]=(...o)=>r.cancelAircraftEdit&&r.cancelAircraftEdit(...o))},"Cancelar")],64)):(Ye(),qe(_t,{key:1},[_("button",{class:"table-btn",type:"button",onClick:o=>r.openAircraft(a.id)},[_("img",{class:"btn-icon",src:s.icons.open,alt:"","aria-hidden":"true"},null,8,gy),e[47]||(e[47]=ot("Abrir",-1))],8,my),_("button",{class:"table-btn",type:"button",disabled:!s.isOwner,onClick:o=>r.startAircraftEdit(a)},[_("img",{class:"btn-icon",src:s.icons.edit,alt:"","aria-hidden":"true"},null,8,vy),e[48]||(e[48]=ot("Editar",-1))],8,_y),_("button",{class:"table-btn aircraft-download-btn",type:"button","aria-label":`Descargar PDF de ${a.code}`,title:`Descargar PDF de ${a.code}`,onClick:o=>r.downloadAircraftPdf(a)},[_("img",{class:"btn-icon",src:s.icons.download,alt:"","aria-hidden":"true"},null,8,Sy)],8,xy)],64)),r.canDeleteAircraft(a)?(Ye(),qe("button",{key:2,class:"table-btn danger-btn",type:"button",onClick:o=>r.deleteAircraft(a.id)},[_("img",{class:"btn-icon",src:s.icons.delete,alt:"","aria-hidden":"true"},null,8,by),e[49]||(e[49]=ot(" Eliminar ",-1))],8,My)):Vt("",!0)])],42,uy))),128))]),s.fleet.aircrafts.length===0?(Ye(),qe("p",yy,"No hay aeronaves registradas.")):Vt("",!0)]),_("form",{class:"aircraft-form",onSubmit:e[29]||(e[29]=Sn((...a)=>r.createAircraft&&r.createAircraft(...a),["prevent"]))},[lt(_("input",{"onUpdate:modelValue":e[26]||(e[26]=a=>s.newAircraft.code=a),type:"text",maxlength:"30",placeholder:"Codigo (ej. PNP-700)",disabled:!s.isOwner},null,8,Ey),[[ct,s.newAircraft.code,void 0,{trim:!0}]]),lt(_("input",{"onUpdate:modelValue":e[27]||(e[27]=a=>s.newAircraft.name=a),type:"text",maxlength:"80",placeholder:"Nombre (ej. Mi-171Sh)",disabled:!s.isOwner},null,8,Ty),[[ct,s.newAircraft.name,void 0,{trim:!0}]]),lt(_("textarea",{"onUpdate:modelValue":e[28]||(e[28]=a=>s.newAircraft.notes=a),maxlength:"240",placeholder:"Notas de la aeronave",disabled:!s.isOwner},null,8,Ay),[[ct,s.newAircraft.notes,void 0,{trim:!0}]]),_("button",{class:"table-btn",type:"submit",disabled:!s.isOwner},[_("img",{class:"btn-icon",src:s.icons.add,alt:"","aria-hidden":"true"},null,8,Ry),e[50]||(e[50]=ot("Crear aeronave",-1))],8,wy),_("p",{class:Dt(["readonly-note",{visible:!s.isOwner}])},"Solo el propietario puede crear aeronaves.",2)],32)])])],512),[[Km,s.activeView==="aeronaves"]]),s.activeView!=="aeronaves"?(Ye(),qe(_t,{key:0},[s.activeView==="dashboard"?(Ye(),qe("section",Cy,[_("article",Py,[_("div",Dy,[e[53]||(e[53]=_("p",{class:"kpi-title"},"Total Componentes",-1)),_("span",Ly,[_("img",{src:s.icons.components,alt:""},null,8,Iy)])]),_("p",Uy,xe(r.metrics.total),1),e[54]||(e[54]=_("p",{class:"kpi-meta"},[_("span",null,"Registrados"),_("strong",null,"100%")],-1)),e[55]||(e[55]=_("div",{class:"kpi-progress"},[_("span",{style:{width:"100%"}})],-1))]),_("article",Ny,[_("div",Fy,[e[56]||(e[56]=_("p",{class:"kpi-title"},"Críticos / Overhaul",-1)),_("span",Oy,[_("img",{src:s.icons.overhaul,alt:""},null,8,By)])]),_("p",Hy,xe(r.metrics.critical),1),_("p",ky,[e[57]||(e[57]=_("span",null,"Requieren atención",-1)),_("strong",null,xe(r.pct(r.metrics.critical)),1)]),_("div",Vy,[_("span",{style:Wt({width:r.pct(r.metrics.critical)})},null,4)])]),_("article",zy,[_("div",Gy,[e[58]||(e[58]=_("p",{class:"kpi-title"},"Alertas Preventivas",-1)),_("span",Wy,[_("img",{src:s.icons.alerts,alt:""},null,8,Xy)])]),_("p",Yy,xe(r.metrics.alert),1),_("p",qy,[e[59]||(e[59]=_("span",null,"Seguimiento cercano",-1)),_("strong",null,xe(r.pct(r.metrics.alert)),1)]),_("div",Ky,[_("span",{style:Wt({width:r.pct(r.metrics.alert)})},null,4)])]),_("article",Zy,[_("div",$y,[e[60]||(e[60]=_("p",{class:"kpi-title"},"En Condiciones",-1)),_("span",Jy,[_("img",{src:s.icons.serviceTime,alt:""},null,8,Qy)])]),_("p",jy,xe(r.metrics.ok),1),_("p",eE,[e[61]||(e[61]=_("span",null,"Operativos",-1)),_("strong",null,xe(r.pct(r.metrics.ok)),1)]),_("div",tE,[_("span",{style:Wt({width:r.pct(r.metrics.ok)})},null,4)])]),_("article",nE,[_("div",iE,[_("div",{class:"ring",style:Wt(r.riskRingStyle)},[_("span",null,xe(r.metrics.risk)+"%",1)],4),_("div",sE,[e[62]||(e[62]=_("p",{class:"kpi-title"},"Riesgo Global",-1)),_("strong",{style:Wt({color:r.riskLabel.color})},xe(r.metrics.risk)+"%",5),_("span",null,"Nivel: "+xe(r.riskLabel.label),1),_("small",null,xe(r.riskAttentionText),1)])])])],512)):Vt("",!0),s.activeView==="dashboard"?(Ye(),qe("section",rE,[_("article",aE,[e[71]||(e[71]=_("h2",null,"Aeronave Seleccionada",-1)),_("p",oE,"Serie "+xe(r.aircraftSeries),1),_("p",lE,xe(r.currentAircraft?r.currentAircraft.name:"--"),1),_("ul",cE,[_("li",null,[e[63]||(e[63]=_("span",null,"Horas Totales (TSN):",-1)),e[64]||(e[64]=ot()),_("span",null,xe(r.formatMetric(r.panelTotals.consumed))+" h",1)]),_("li",null,[e[65]||(e[65]=_("span",null,"Vida Total Asignada:",-1)),e[66]||(e[66]=ot()),_("span",null,xe(r.formatMetric(r.panelTotals.assigned))+" h",1)]),_("li",null,[e[67]||(e[67]=_("span",null,"Horas Remanentes:",-1)),e[68]||(e[68]=ot()),_("span",null,xe(r.formatMetric(r.panelTotals.remaining))+" h",1)]),_("li",null,[e[69]||(e[69]=_("span",null,"Vencimiento Calendario:",-1)),e[70]||(e[70]=ot()),_("span",null,xe(r.nextDueDate),1)])]),_("div",uE,xe(r.aircraftState),1),_("p",dE,"Vida util consumida: "+xe(r.formatMetric(r.consumedPct))+"%",1),_("div",fE,[_("div",{style:Wt({width:`${r.consumedPct}%`})},null,4)])]),_("article",hE,[e[72]||(e[72]=_("h2",null,"Consumo de Recursos (TSO / Arranques)",-1)),e[73]||(e[73]=_("p",{class:"panel-sub"},"Comparación: consumido vs remanente por componente",-1)),e[74]||(e[74]=_("div",{class:"chart-legend","aria-label":"Leyenda de consumo"},[_("span",null,[_("i",{class:"legend-swatch consumed"}),ot("Consumido")]),_("span",null,[_("i",{class:"legend-swatch remaining"}),ot("Remanente")])],-1)),_("div",pE,[(Ye(!0),qe(_t,null,nn(r.chartBars,a=>(Ye(),qe("div",{key:a.key,class:"resource-row"},[_("div",mE,[_("div",gE,[_("span",{class:Dt(["component-logo",a.categoryClass])},xe(a.logo),3),_("span",null,xe(a.label),1)]),_("strong",null,xe(a.percentage)+"%",1)]),_("div",{class:"resource-track","aria-label":`${a.label}: ${a.consumed} consumido, ${a.remaining} remanente`},[_("span",{class:"resource-segment consumed",style:Wt({width:`${a.consumedWidth}%`})},null,4),_("span",{class:"resource-segment remaining",style:Wt({width:`${a.remainingWidth}%`})},null,4)],8,_E),_("div",vE,[_("span",null,xe(r.formatMetric(a.consumed)),1),_("span",null,xe(r.formatMetric(a.remaining)),1)])]))),128))])]),_("article",xE,[_("h2",SE,[_("img",{src:s.icons.due,alt:"","aria-hidden":"true"},null,8,ME),e[75]||(e[75]=ot("Proximos Vencimientos",-1))]),e[76]||(e[76]=_("p",{class:"panel-sub"},"Control calendario",-1)),_("ul",bE,[(Ye(!0),qe(_t,null,nn(r.dueEvents,a=>(Ye(),qe("li",{key:a.key},[_("span",null,xe(a.component),1),_("span",{class:Dt(["date",a.className])},xe(a.due),3)]))),128))])])])):Vt("",!0),s.activeView==="componentes"?(Ye(),qe("section",yE,[_("article",EE,[e[79]||(e[79]=_("h2",null,"Consumo de Recursos por Categoría",-1)),e[80]||(e[80]=_("p",{class:"panel-sub"},"Distribución del consumo registrado",-1)),_("div",TE,[_("div",{class:"donut-chart",style:Wt(r.categoryDonutStyle)},[_("div",AE,[e[77]||(e[77]=_("span",null,"Total",-1)),_("strong",null,xe(r.formatMetric(r.metrics.consumedTotal)),1),e[78]||(e[78]=_("small",null,"HRS / ARR",-1))])],4),_("div",wE,[(Ye(!0),qe(_t,null,nn(r.categoryChart,a=>(Ye(),qe("div",{key:a.key,class:"chart-list-row"},[_("span",null,[_("i",{class:"legend-swatch",style:Wt({background:a.color})},null,4),ot(xe(a.label),1)]),_("strong",null,[ot(xe(r.formatMetric(a.value))+" ",1),_("small",null,xe(a.percentage)+"%",1)])]))),128))])])]),_("article",RE,[e[82]||(e[82]=_("h2",null,"Tendencia de Consumo (TSO)",-1)),e[83]||(e[83]=_("p",{class:"panel-sub"},"Comparación de consumo y remanente por componente",-1)),e[84]||(e[84]=_("div",{class:"chart-legend trend-legend"},[_("span",null,[_("i",{class:"legend-swatch consumed"}),ot("Consumido")]),_("span",null,[_("i",{class:"legend-swatch remaining"}),ot("Remanente")])],-1)),_("div",CE,[_("div",PE,xe(r.formatMetric(r.trendChart.max)),1),e[81]||(e[81]=_("div",{class:"trend-axis-label bottom"},"0",-1)),(Ye(),qe("svg",DE,[(Ye(!0),qe(_t,null,nn(r.trendChart.gridLines,a=>(Ye(),qe("line",{key:a.y,x1:"38",y1:a.y,x2:"590",y2:a.y,class:"trend-grid-line"},null,8,LE))),128)),_("polyline",{points:r.trendChart.consumedPoints,class:"trend-line consumed-line"},null,8,IE),_("polyline",{points:r.trendChart.remainingPoints,class:"trend-line remaining-line"},null,8,UE),(Ye(!0),qe(_t,null,nn(r.trendChart.points,a=>(Ye(),qe("g",{key:a.key},[_("circle",{cx:a.x,cy:a.consumedY,r:"4",class:"trend-point consumed-point"},null,8,NE),_("circle",{cx:a.x,cy:a.remainingY,r:"4",class:"trend-point remaining-point"},null,8,FE),_("text",{x:a.x,y:"176","text-anchor":"middle",class:"trend-label"},xe(a.label),9,OE)]))),128))]))])]),_("article",BE,[e[86]||(e[86]=_("h2",null,"Estado de Componentes",-1)),e[87]||(e[87]=_("p",{class:"panel-sub"},"Situación operativa actual",-1)),_("div",HE,[_("div",{class:"donut-chart status-donut",style:Wt(r.statusDonutStyle)},[_("div",kE,[_("strong",null,xe(r.metrics.total),1),e[85]||(e[85]=_("span",null,"Total",-1))])],4),_("div",VE,[(Ye(!0),qe(_t,null,nn(r.statusChart,a=>(Ye(),qe("div",{key:a.key,class:"chart-list-row"},[_("span",null,[_("i",{class:"legend-swatch",style:Wt({background:a.color})},null,4),ot(xe(a.label),1)]),_("strong",null,[ot(xe(a.value)+" ",1),_("small",null,xe(a.percentage)+"%",1)])]))),128))])])])])):Vt("",!0),s.activeView==="base-datos"?(Ye(),qe("section",zE,[_("div",GE,[e[90]||(e[90]=_("h2",null,"Base de Datos de Componentes",-1)),_("div",WE,[_("div",XE,[_("button",{class:"table-btn",type:"button",disabled:!s.isOwner,onClick:e[30]||(e[30]=a=>s.componentAddMenuOpen=!s.componentAddMenuOpen)},[_("img",{class:"btn-icon",src:s.icons.add,alt:"","aria-hidden":"true"},null,8,qE),e[88]||(e[88]=ot("Agregar componente",-1))],8,YE),s.componentAddMenuOpen&&s.isOwner?(Ye(),qe("div",KE,[_("button",{type:"button",onClick:e[31]||(e[31]=a=>r.addRow("generic"))},"Nuevo componente"),_("button",{type:"button",onClick:e[32]||(e[32]=a=>r.addRow("apu-tg-16m"))},"APU TG-16M")])):Vt("",!0)]),_("button",{class:"table-btn",type:"button",disabled:!s.isOwner,onClick:e[33]||(e[33]=(...a)=>r.resetDb&&r.resetDb(...a))},[_("img",{class:"btn-icon",src:s.icons.restore,alt:"","aria-hidden":"true"},null,8,$E),e[89]||(e[89]=ot("Restaurar datos",-1))],8,ZE)])]),_("p",{class:Dt(["readonly-note",{visible:!s.isOwner}]),style:{margin:"0 14px 10px"}}," Modo solo lectura: solo el propietario puede editar la base de datos. ",2),_("div",JE,[_("table",null,[e[92]||(e[92]=_("thead",null,[_("tr",null,[_("th",null,"Orden"),_("th",null,"Componente"),_("th",null,"Serie"),_("th",null,"Fecha fabricacion"),_("th",null,"Taller"),_("th",null,"Ultimo Overhaul"),_("th",null,"Asignado TBO (hrs)"),_("th",null,"Asignado TBO (años)"),_("th",null,"Consumido TBO hrs"),_("th",null,"Consumido TBO años"),_("th",null,"Asignado TSN (hrs)"),_("th",null,"Asignado TSN (años)"),_("th",null,"Consumido TSN hrs"),_("th",null,"Consumido TSN años"),_("th",null,"Remanente TBO (hrs)"),_("th",null,"Remanente TBO (años)"),_("th",null,"Remanente TSN (hrs)"),_("th",null,"Remanente TSN (años)"),_("th",null,"Arranques TSN de motores"),_("th",null,"Gaso-horas TSN"),_("th",null,"Arranque TBO de motores"),_("th",null,"Gaso-horas TBO"),_("th",null,"Notas"),_("th",null,"Vencimiento"),_("th",null,"Estado"),_("th",null,"Accion")])],-1)),_("tbody",null,[(Ye(!0),qe(_t,null,nn(r.currentRows,(a,o)=>(Ye(),qe("tr",{key:`${r.currentAircraft.id}-${o}`,class:Dt({"dragging-row":s.draggingRowIndex===o}),onDragover:e[35]||(e[35]=Sn(()=>{},["prevent"])),onDrop:Sn(l=>r.dropRow(o),["prevent"])},[_("td",jE,[_("button",{class:"row-drag-handle",type:"button",draggable:"true","aria-label":"Arrastrar componente",disabled:!s.isOwner,onDragstart:l=>r.startRowDrag(l,o),onDragend:e[34]||(e[34]=(...l)=>r.finishRowDrag&&r.finishRowDrag(...l))}," ⋮⋮ ",40,eT)]),_("td",null,[_("div",tT,[_("span",{class:Dt(["component-logo",r.categoryClass(a)])},xe(r.componentLogo(a)),3),lt(_("input",{"onUpdate:modelValue":l=>a.component=l,class:"cell-input",disabled:!s.isOwner,onChange:l=>r.saveRowFieldChange(a,"Componente")},null,40,nT),[[ct,a.component]])])]),_("td",null,[lt(_("input",{"onUpdate:modelValue":l=>a.series=l,class:"cell-input",disabled:!s.isOwner,onChange:l=>r.saveRowFieldChange(a,"Serie")},null,40,iT),[[ct,a.series]])]),_("td",null,[lt(_("input",{"onUpdate:modelValue":l=>a.manufactureDate=l,class:"cell-input",disabled:!s.isOwner,placeholder:"dd/mm/aaaa",onChange:l=>r.saveRowFieldChange(a,"Fecha fabricacion")},null,40,sT),[[ct,a.manufactureDate]])]),_("td",null,[lt(_("input",{"onUpdate:modelValue":l=>a.workshop=l,class:"cell-input",disabled:!s.isOwner,onChange:l=>r.saveRowFieldChange(a,"Taller")},null,40,rT),[[ct,a.workshop]])]),_("td",null,[lt(_("input",{"onUpdate:modelValue":l=>a.overhaul=l,class:"cell-input",disabled:!s.isOwner,onInput:l=>r.updateAllDerived(a),onChange:l=>r.saveRowFieldChange(a,"Ultimo overhaul","all")},null,40,aT),[[ct,a.overhaul]])]),_("td",null,[lt(_("input",{"onUpdate:modelValue":l=>a.assignedTboHours=l,class:"cell-input numeric-input",disabled:!s.isOwner,onInput:l=>r.updateTboDerived(a),onChange:l=>r.saveRowFieldChange(a,"Asignado TBO horas","tbo")},null,40,oT),[[ct,a.assignedTboHours]])]),_("td",null,[lt(_("input",{"onUpdate:modelValue":l=>a.assignedTboYears=l,class:"cell-input numeric-input",disabled:!s.isOwner,onInput:l=>r.updateTboDerived(a),onChange:l=>r.saveRowFieldChange(a,"Asignado TBO años","tbo")},null,40,lT),[[ct,a.assignedTboYears]])]),_("td",null,[lt(_("input",{"onUpdate:modelValue":l=>a.consumedTboHours=l,class:"cell-input numeric-input",disabled:!s.isOwner,onInput:l=>r.updateTboDerived(a),onChange:l=>r.saveRowFieldChange(a,"Consumido TBO horas","tbo")},null,40,cT),[[ct,a.consumedTboHours]])]),_("td",null,[lt(_("input",{"onUpdate:modelValue":l=>a.consumedTboYears=l,class:"cell-input numeric-input calculated-input",disabled:"",readonly:""},null,8,uT),[[ct,a.consumedTboYears]])]),_("td",null,[lt(_("input",{"onUpdate:modelValue":l=>a.assignedTsnHours=l,class:"cell-input numeric-input",disabled:!s.isOwner,onInput:l=>r.updateTsnDerived(a),onChange:l=>r.saveRowFieldChange(a,"Asignado TSN horas","tsn")},null,40,dT),[[ct,a.assignedTsnHours]])]),_("td",null,[lt(_("input",{"onUpdate:modelValue":l=>a.assignedTsnYears=l,class:"cell-input numeric-input",disabled:!s.isOwner,onInput:l=>r.updateTsnDerived(a),onChange:l=>r.saveRowFieldChange(a,"Asignado TSN años","tsn")},null,40,fT),[[ct,a.assignedTsnYears]])]),_("td",null,[lt(_("input",{"onUpdate:modelValue":l=>a.consumedTsnHours=l,class:"cell-input numeric-input",disabled:!s.isOwner,onInput:l=>r.updateTsnDerived(a),onChange:l=>r.saveRowFieldChange(a,"Consumido TSN horas","tsn")},null,40,hT),[[ct,a.consumedTsnHours]])]),_("td",null,[lt(_("input",{"onUpdate:modelValue":l=>a.consumedTsnYears=l,class:"cell-input numeric-input calculated-input",disabled:"",readonly:""},null,8,pT),[[ct,a.consumedTsnYears]])]),_("td",null,[lt(_("input",{"onUpdate:modelValue":l=>a.remainingTboHours=l,class:"cell-input numeric-input calculated-input",disabled:"",readonly:""},null,8,mT),[[ct,a.remainingTboHours]])]),_("td",null,[lt(_("input",{"onUpdate:modelValue":l=>a.remainingTboYears=l,class:"cell-input numeric-input calculated-input",disabled:"",readonly:""},null,8,gT),[[ct,a.remainingTboYears]])]),_("td",null,[lt(_("input",{"onUpdate:modelValue":l=>a.remainingTsnHours=l,class:"cell-input numeric-input calculated-input",disabled:"",readonly:""},null,8,_T),[[ct,a.remainingTsnHours]])]),_("td",null,[lt(_("input",{"onUpdate:modelValue":l=>a.remainingTsnYears=l,class:"cell-input numeric-input calculated-input",disabled:"",readonly:""},null,8,vT),[[ct,a.remainingTsnYears]])]),_("td",null,[lt(_("input",{"onUpdate:modelValue":l=>a.motorStartsTsn=l,class:"cell-input numeric-input",disabled:!s.isOwner,onChange:l=>r.saveRowFieldChange(a,"Arranques TSN de motores")},null,40,xT),[[ct,a.motorStartsTsn]])]),_("td",null,[lt(_("input",{"onUpdate:modelValue":l=>a.gasHoursTsn=l,class:"cell-input numeric-input",disabled:!s.isOwner,onChange:l=>r.saveRowFieldChange(a,"Gaso-horas TSN")},null,40,ST),[[ct,a.gasHoursTsn]])]),_("td",null,[lt(_("input",{"onUpdate:modelValue":l=>a.motorStartsTbo=l,class:"cell-input numeric-input",disabled:!s.isOwner,onChange:l=>r.saveRowFieldChange(a,"Arranque TBO de motores")},null,40,MT),[[ct,a.motorStartsTbo]])]),_("td",null,[lt(_("input",{"onUpdate:modelValue":l=>a.gasHoursTbo=l,class:"cell-input numeric-input",disabled:!s.isOwner,onChange:l=>r.saveRowFieldChange(a,"Gaso-horas TBO")},null,40,bT),[[ct,a.gasHoursTbo]])]),_("td",null,[lt(_("textarea",{"onUpdate:modelValue":l=>a.notes=l,class:"cell-input notes-input",disabled:!s.isOwner,maxlength:"360",placeholder:"Notas del componente",onChange:l=>r.saveRowFieldChange(a,"Notas")},null,40,yT),[[ct,a.notes]])]),_("td",null,[lt(_("input",{"onUpdate:modelValue":l=>a.due=l,class:"cell-input calculated-input",disabled:"",readonly:""},null,8,ET),[[ct,a.due]])]),_("td",null,[_("span",{class:Dt(["status",r.statusClass(a)])},xe(r.getStatus(a)),3)]),_("td",null,[_("button",{class:"table-btn danger-btn",type:"button",disabled:!s.isOwner,onClick:l=>r.deleteRow(o)},[_("img",{class:"btn-icon",src:s.icons.delete,alt:"","aria-hidden":"true"},null,8,AT),e[91]||(e[91]=ot("Eliminar",-1))],8,TT)])],42,QE))),128))])])])],512)):Vt("",!0),s.activeView==="alertas"?(Ye(),qe("section",wT,[_("div",RT,[_("article",CT,[e[93]||(e[93]=_("p",null,"Overhaul Requerido",-1)),_("b",PT,xe(r.fleetAlertMetrics.critical),1)]),_("article",DT,[e[94]||(e[94]=_("p",null,"Alertas Preventivas",-1)),_("b",LT,xe(r.fleetAlertMetrics.alert),1)]),_("article",IT,[e[95]||(e[95]=_("p",null,"Proximos 90 dias",-1)),_("b",UT,xe(r.fleetAlertMetrics.dueIn90),1)]),_("article",NT,[e[96]||(e[96]=_("p",null,"Proximos 180 dias",-1)),_("b",FT,xe(r.fleetAlertMetrics.dueIn180),1)]),_("article",OT,[e[97]||(e[97]=_("p",null,"Riesgo Global",-1)),_("b",{style:Wt({color:r.fleetRiskLabel.color})},xe(r.fleetAlertMetrics.risk)+"%",5)])]),_("article",BT,[e[98]||(e[98]=_("h2",null,"Componentes en Alerta",-1)),e[99]||(e[99]=_("p",{class:"panel-sub"},"Alertas consolidadas de todas las aeronaves",-1)),_("ul",HT,[(Ye(!0),qe(_t,null,nn(r.allAlertRows,a=>(Ye(),qe("li",{key:a.key},[_("span",null,[_("strong",kT,xe(a.aircraftCode),1),ot(xe(a.component),1)]),_("span",{class:Dt(["date",a.className])},xe(a.status),3)]))),128))])])])):Vt("",!0),s.activeView==="calendario"?(Ye(),qe("section",VT,[_("h2",zT,[_("img",{src:s.icons.due,alt:"","aria-hidden":"true"},null,8,GT),e[100]||(e[100]=ot("Calendario de Vencimientos",-1))]),e[101]||(e[101]=_("p",{class:"panel-sub"},"Proximos controles por fecha",-1)),_("ul",WT,[(Ye(!0),qe(_t,null,nn(r.dueEvents,a=>(Ye(),qe("li",{key:a.key},[_("span",null,xe(a.component),1),_("span",{class:Dt(["date",a.className])},xe(a.due),3)]))),128))])])):Vt("",!0),s.activeView==="historial"?(Ye(),qe("section",XT,[e[103]||(e[103]=_("div",{class:"table-title"},[_("div",null,[_("h2",null,"Historial"),_("p",{class:"panel-sub"},"Ultimos 20 cambios del sistema y registro de overhaul")])],-1)),_("div",YT,[(Ye(!0),qe(_t,null,nn(r.recentChanges,a=>(Ye(),qe("article",{key:a.id,class:"change-item"},[_("div",null,[_("strong",null,[ot(xe(a.action)+" ",1),a.aircraftCode?(Ye(),qe("span",qT,xe(a.aircraftCode),1)):Vt("",!0)]),_("p",null,xe(a.detail),1)]),_("span",null,xe(r.formatChangeDate(a.timestamp)),1)]))),128)),r.recentChanges.length===0?(Ye(),qe("p",KT,"Aun no hay cambios registrados.")):Vt("",!0)]),e[104]||(e[104]=_("div",{class:"history-section-title"},"Historial de Overhaul",-1)),_("div",ZT,[_("table",$T,[e[102]||(e[102]=_("thead",null,[_("tr",null,[_("th",null,"Componente"),_("th",null,"Serie"),_("th",null,"Fecha fabricacion"),_("th",null,"Taller"),_("th",null,"Ultimo Overhaul"),_("th",null,"Vencimiento"),_("th",null,"Estado")])],-1)),_("tbody",null,[(Ye(!0),qe(_t,null,nn(r.historyRows,a=>(Ye(),qe("tr",{key:a.key},[_("td",null,xe(a.component),1),_("td",null,xe(a.series),1),_("td",null,xe(a.manufactureDate),1),_("td",null,xe(a.workshop),1),_("td",null,xe(a.overhaul),1),_("td",null,xe(a.due),1),_("td",null,[_("span",{class:Dt(["status",a.statusClass])},xe(a.status),3)])]))),128))])])])])):Vt("",!0),s.activeView==="papelera"?(Ye(),qe("section",JT,[e[108]||(e[108]=_("div",{class:"table-title"},[_("div",null,[_("h2",null,"Papelera"),_("p",{class:"panel-sub"},"Elementos eliminados, disponibles por 30 dias")])],-1)),_("div",QT,[_("table",jT,[e[107]||(e[107]=_("thead",null,[_("tr",null,[_("th",null,"Tipo"),_("th",null,"Aeronave"),_("th",null,"Elemento"),_("th",null,"Eliminado"),_("th",null,"Expira"),_("th",null,"Accion")])],-1)),_("tbody",null,[(Ye(!0),qe(_t,null,nn(r.trashRows,a=>(Ye(),qe("tr",{key:a.id},[_("td",null,xe(a.typeLabel),1),_("td",null,xe(a.aircraftCode),1),_("td",null,xe(a.name),1),_("td",null,xe(r.formatChangeDate(a.deletedAt)),1),_("td",null,xe(r.formatChangeDate(a.expiresAt)),1),_("td",null,[_("button",{class:"table-btn",type:"button",disabled:!s.isOwner,onClick:o=>r.restoreTrashItem(a.id)},[_("img",{class:"btn-icon",src:s.icons.restore,alt:"","aria-hidden":"true"},null,8,tA),e[105]||(e[105]=ot("Restaurar",-1))],8,eA)])]))),128)),r.trashRows.length===0?(Ye(),qe("tr",nA,[...e[106]||(e[106]=[_("td",{colspan:"6",class:"empty-cell"},"La papelera esta vacia.",-1)])])):Vt("",!0)])])])])):Vt("",!0)],64)):Vt("",!0),_("footer",null,xe(new Date().getFullYear())+" Sistema de Gestion de Recursos Aeronauticos · "+xe(r.currentAircraft?r.currentAircraft.code:"PNP-501")+" · Todos los derechos reservados ",1)])])):(Ye(),qe("section",Sb,[_("canvas",Mb,null,512),_("form",{class:"login-card",onSubmit:e[14]||(e[14]=Sn((...a)=>r.signInWithEmail&&r.signInWithEmail(...a),["prevent"]))},[e[37]||(e[37]=_("div",{class:"login-brand"},[_("p",null,"DIVMAAER"),_("h1",null,"Control de Calidad")],-1)),e[38]||(e[38]=_("label",{for:"login-email"},"Correo",-1)),lt(_("input",{id:"login-email","onUpdate:modelValue":e[0]||(e[0]=a=>s.loginEmail=a),class:"login-input",type:"email",autocomplete:"username",placeholder:"correo@ejemplo.com",disabled:s.authBusy},null,8,bb),[[ct,s.loginEmail,void 0,{trim:!0}]]),e[39]||(e[39]=_("label",{for:"login-password"},"Contrasena",-1)),_("div",yb,[lt(_("input",{id:"login-password","onUpdate:modelValue":e[1]||(e[1]=a=>s.loginPassword=a),class:"login-input",type:s.passwordVisible?"text":"password",autocomplete:"current-password",placeholder:"Contrasena",disabled:s.authBusy},null,8,Eb),[[mg,s.loginPassword]]),_("button",{class:"password-eye-btn",type:"button","aria-label":"Ver contrasena mientras se presiona",title:"Ver contrasena",disabled:s.authBusy,onMousedown:e[2]||(e[2]=Sn((...a)=>r.showPassword&&r.showPassword(...a),["prevent"])),onMouseup:e[3]||(e[3]=(...a)=>r.hidePassword&&r.hidePassword(...a)),onMouseleave:e[4]||(e[4]=(...a)=>r.hidePassword&&r.hidePassword(...a)),onTouchstart:e[5]||(e[5]=Sn((...a)=>r.showPassword&&r.showPassword(...a),["prevent"])),onTouchend:e[6]||(e[6]=(...a)=>r.hidePassword&&r.hidePassword(...a)),onTouchcancel:e[7]||(e[7]=(...a)=>r.hidePassword&&r.hidePassword(...a)),onKeydown:[e[8]||(e[8]=Br(Sn((...a)=>r.showPassword&&r.showPassword(...a),["prevent"]),["space"])),e[10]||(e[10]=Br(Sn((...a)=>r.showPassword&&r.showPassword(...a),["prevent"]),["enter"]))],onKeyup:[e[9]||(e[9]=Br((...a)=>r.hidePassword&&r.hidePassword(...a),["space"])),e[11]||(e[11]=Br((...a)=>r.hidePassword&&r.hidePassword(...a),["enter"]))]},[_("img",{class:"btn-icon",src:s.icons.eye,alt:"","aria-hidden":"true"},null,8,Ab)],40,Tb)]),_("div",wb,[_("button",{class:"login-btn primary",type:"submit",disabled:s.authBusy||!s.authReady},[_("img",{class:"btn-icon",src:s.icons.login,alt:"","aria-hidden":"true"},null,8,Cb),ot(" "+xe(s.authBusy?"Procesando...":"Ingresar"),1)],8,Rb),_("button",{class:"login-btn",type:"button",disabled:s.authBusy||!s.authReady,onClick:e[12]||(e[12]=(...a)=>r.createEmailUser&&r.createEmailUser(...a))},[_("img",{class:"btn-icon",src:s.icons.user,alt:"","aria-hidden":"true"},null,8,Db),e[36]||(e[36]=ot(" Crear cuenta ",-1))],8,Pb)]),_("button",{class:"login-link-btn",type:"button",disabled:s.authBusy||!s.authReady,onClick:e[13]||(e[13]=(...a)=>r.sendPasswordReset&&r.sendPasswordReset(...a))}," Restablecer contrasena ",8,Lb),_("p",{class:Dt(["login-hint",{error:s.authHintError}])},xe(s.authHint),3)],32)]))],2)}const sA=cb(xb,[["render",iA]]);bg(sA).mount("#app");
